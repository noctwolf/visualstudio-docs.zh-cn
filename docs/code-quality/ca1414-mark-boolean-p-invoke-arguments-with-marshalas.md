---
title: CA1414： 标记布尔型 P Invoke 自变量用 MarshalAs
ms.date: 11/04/2016
...
## <a name="see-also"></a>请参阅
 <xref:System.Runtime.InteropServices.UnmanagedType?displayProperty=fullName> [与非托管代码交互操作](/dotnet/framework/interop/index)