...
|[CA1724：类型名不应与命名空间冲突](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|类型名不应与在.NET Framework 类库中定义的命名空间的名称。 此规则的冲突会降低库的可用性。|
