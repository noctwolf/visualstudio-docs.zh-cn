...
```
 ...
 若要查看有关如何创建安全描述符的完整示例，请参阅[为 c + + 中的新对象创建安全描述符](http://msdn.microsoft.com/library/aa446595.aspx)。 有关详细信息，请参阅[创建 DACL](/windows/desktop/SecBP/creating-a-dacl)。