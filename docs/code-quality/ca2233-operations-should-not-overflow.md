...
## <a name="see-also"></a>请参阅
 <xref:System.OverflowException?displayProperty=fullName> [C# 运算符](/dotnet/csharp/language-reference/operators/index) [Checked 和 Unchecked](/dotnet/csharp/language-reference/keywords/checked-and-unchecked)