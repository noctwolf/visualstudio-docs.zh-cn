...
你可以使用工作项跟踪中记录工作项的功能[!INCLUDE[vsPreLong](../code-quality/includes/vsprelong_md.md)]。 若要使用此功能，你的项目必须是团队项目中的一部分[!INCLUDE[esprfound](../code-quality/includes/esprfound_md.md)]。  
