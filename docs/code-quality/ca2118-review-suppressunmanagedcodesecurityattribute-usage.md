...
## <a name="see-also"></a>请参阅
 <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute?displayProperty=fullName> [安全编码准则](/dotnet/standard/security/secure-coding-guidelines)[数据和建模](/dotnet/framework/data/index)[链接需求](/dotnet/framework/misc/link-demands)
