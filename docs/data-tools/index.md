...
ms.locfileid: "58323235"
---
# <a name="use-data-tools-in-visual-studio-to-develop-data-solutions"></a>在 Visual Studio 中使用数据工具开发数据解决方案

了解如何在 Visual Studio 中借助数据工具并通过 SQL Server、Azure Data Lake 或 Hadoop 开发和测试数据解决方案。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解如何通过 Azure Data Lake 使用 U-SQL 和 .NET 开发大数据应用程序</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解如何在 Azure HDInsight 上使用 Hadoop 运行 Hive 查询</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解如何通过 Azure 流分析开发近实时大数据解决方案</h3>
                    </div>
                </div>
            </div>
        </div>
