...
![与 BindingNavigator 的 GridView](../data-tools/media/raddata-gridview-with-bindingnavigator.png)

通过单击中的每个右上角的智能标记，可以自定义 DataGridView 控件与 BindingNavigator 的行为：

![DataGridView 控件与绑定导航器的智能标记](../data-tools/media/raddata-datagridview-and-binding-navigator-smart-tags.png)
