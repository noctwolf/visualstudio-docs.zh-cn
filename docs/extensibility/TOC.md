...
# [创建第一个扩展：Hello World](extensibility-hello-world.md)
...
# [操作说明：Visual Studio 的往返扩展](how-to-roundtrip-VSIXs.md)
# [语言服务器协议](language-server-protocol.md)
##[添加语言服务器协议扩展](adding-an-lsp-extension.md)
#[打开文件夹](open-folder.md)
##[工作区](workspaces.md)
##[文件上下文](workspace-file-contexts.md)
##[索引](workspace-indexing.md)
##[语言服务](workspace-language-services.md)
##[生成](workspace-build.md)
...
## [如何：诊断由扩展引起的 UI 延迟](how-to-diagnose-ui-delays-caused-by-extensions.md)
...
### [VSIX 语言包架构 2.0 参考](vsix-language-pack-schema-2-0-reference.md)
...
## [查找 Visual Studio](locating-visual-studio.md)
