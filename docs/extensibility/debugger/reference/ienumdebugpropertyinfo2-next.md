---
title: IEnumDebugPropertyInfo2::Next |Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>参数  
 ...
 `rgelt`  
 [在中，out]数组[DEBUG_PROPERTY_INFO](../../../extensibility/debugger/reference/debug-property-info.md)元素填充的。  
