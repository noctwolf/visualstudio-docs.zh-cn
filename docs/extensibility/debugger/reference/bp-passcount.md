...
## <a name="members"></a>成员
`dwPassCount` 将跳过该断点之前触发它的时间数。

`stylePassCount` 中的值[BP_PASSCOUNT_STYLE](../../../extensibility/debugger/reference/bp-passcount-style.md)枚举，用于指定断点的样式通过次数。
