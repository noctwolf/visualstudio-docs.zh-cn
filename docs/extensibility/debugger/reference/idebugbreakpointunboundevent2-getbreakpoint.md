---
title: IDebugBreakpointUnboundEvent2::GetBreakpoint |Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>参数  
 `ppBP`  
 [out]返回[IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md)表示未绑定的断点的对象。  
