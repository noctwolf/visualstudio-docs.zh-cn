---
title: 枚举 （Visual Studio 调试） |Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
以下是枚举的[!INCLUDE[vsprvs](../../../code-quality/includes/vsprvs_md.md)]Debugging SDK。  
 ...
 枚举可用于设置断点时指定的附加信息的可选标志的有效值。 此枚举扩展[BP_FLAGS](../../../extensibility/debugger/reference/bp-flags.md)枚举。  
  
 [BP_LOCATION_TYPE](../../../extensibility/debugger/reference/bp-location-type.md)  
 指定断点请求断点的位置类型。  
  
 [BP_PASSCOUNT_STYLE](../../../extensibility/debugger/reference/bp-passcount-style.md)  
 指定将导致触发断点的断点传递计数与关联的条件。  
