...
||&LT; HOME_PAGE_BOOKS_INSTALLED_SECTION_ADD / &GT;|标题部分 Branding.xml 标记\<HomePageInstalledBooks >，从应用程序，生成的数据\<HomePageNoBooksInstalled > 当安装没有书的。|  
...
若要直接联系帮助查看器 PM 团队，发送到的电子邮件 hlpfdbk@microsoft.com