---
title: 公开 Visual Studio SDK 中的事件 |Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
```  
 ...
 在上面的代码，`g_wszAutomationProjects`是你的项目集合 ("FigProjects") 的名称`g_wszAutomationProjectsEvents`("FigProjectsEvents") 和`g_wszAutomationProjectItemsEvents`("FigProjectItemEvents") 是项目事件的名称和项目项源自的事件你VSPackage 实现。  
