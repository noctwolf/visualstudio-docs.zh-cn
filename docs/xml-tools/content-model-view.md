...
## <a name="workspace-panel"></a>工作区面板
 ...
 将节点添加到工作区后，节点的列表将显示在**工作区**的内容模型视图的面板。 当选择中的节点**工作区**面板，它们显示在内容模型视图的设计图面上。 若要从工作区中删除节点，请使用 XSD 设计器工具栏中，**工作区**面板上下文菜单或**删除**密钥。
...
## <a name="properties-window"></a>“属性”窗口
 ...
 使用上下文菜单可初始打开**属性**窗口。 默认情况下**属性**窗口显示在 Visual Studio 的右下角中。 当您单击的内容模型视图中呈现的节点时，该节点的属性显示在**属性**窗口。
...
## <a name="xml-editor-integration"></a>XML 编辑器集成
 ...
 您可以之间来回切换**XSD 设计器**和 XML 编辑器，通过使用上下文菜单。
