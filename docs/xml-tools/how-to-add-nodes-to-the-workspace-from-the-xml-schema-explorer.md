...
ms.locfileid: "53960506"
---
# <a name="how-to-add-nodes-to-the-workspace-from-the-xml-schema-explorer"></a>如何：从 XML 架构资源管理器向工作区添加节点

本主题说明如何将节点添加到[XML 架构设计器工作区](../xml-tools/xml-schema-designer-workspace.md)从**XML 架构资源管理器**。 这可以通过拖放节点从实现**XML 架构资源管理器**到 XSD 设计器视图，或使用**XML 架构资源管理器的**上下文菜单。 您还可以添加作为执行的搜索结果突出显示的节点**XML 架构资源管理器**。 有关更多信息，请参见[如何：将架构集搜索结果节点添加到工作区](../xml-tools/how-to-add-schema-set-search-result-nodes-to-the-workspace.md)。
