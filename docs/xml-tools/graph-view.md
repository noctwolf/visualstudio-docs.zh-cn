...
## <a name="design-surface"></a>设计图面
 ...
 如果设计图面为空，XML 编辑器中， **XML 架构资源管理器**，并显示水印。 *水印*是指向所有 XSD 设计器视图的列表。
...
## <a name="panscroll"></a>平移/滚动
 ...
 您可以通过使用滚动条，或在按住平移设计图面**Ctrl**键的同时单击并拖动鼠标。 如果使用单击并拖动鼠标的方法平移设计图面，光标将更改为指向四个方向的十字箭头。
