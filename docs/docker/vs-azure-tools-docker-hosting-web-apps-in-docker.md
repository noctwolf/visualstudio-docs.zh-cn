...
## <a name="1-create-an-aspnet-core-web-app"></a>1.创建 ASP.NET Core Web 应用
...
4. 在“创建新 Azure 容器注册表”中填写所需的值。
    ...
    ![Visual Studio 的创建 Azure 容器注册表对话框](media/vs-azure-tools-docker-hosting-web-apps-in-docker/vs-acr-provisioning-dialog.png)
