...
本教程介绍了如何创建 Node.js 和 React 应用、转译 JSX 和进行调试。 若要了解详细信息，请参阅[针对 GitHub 上 Visual Studio 的 Node.js 工具](https://github.com/Microsoft/nodejstools)。