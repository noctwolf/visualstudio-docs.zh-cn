...
本教程介绍了如何使用 Express 创建和运行 Node.js 应用和使用调试程序命中断点。 若要了解详细信息，请参阅[针对 GitHub 上 Visual Studio 的 Node.js 工具](https://github.com/Microsoft/nodejstools)。