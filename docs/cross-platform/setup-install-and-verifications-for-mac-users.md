...
1.  确保 Mac 在网络上可用且已与 Visual Studio 配对，如[连接到 Mac](https://developer.xamarin.com/guides/ios/getting_started/installation/windows/#Connecting_to_the_Mac) (xamarin.com) 中所述。
