...
```
 ...
 你可以指定自己的编辑器或编辑器中提供[!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)]，如<xref:System.Windows.Forms.Design.FileNameEditor>或<xref:System.Drawing.Design.ImageEditor>。 例如，使用以下过程以用户可在其中输入文件名称的属性。
