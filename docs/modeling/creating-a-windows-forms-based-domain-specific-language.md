...
可以使用 Windows 窗体以显示特定于域的语言 (DSL) 模型，而不是使用 DSL 关系图的状态。 本主题将指导你通过使用 Visual Studio 可视化和建模 SDK 对 DSL 绑定 Windows 窗体。

下图显示了 Windows 窗体 UI 和 DSL 实例的模型资源管理器：

![在 Visual Studio 中的 DSL 实例](../modeling/media/dsl-wpf-2.png)
...
### <a name="define-your-dsl-model-as-a-data-source"></a>定义 DSL 模型作为数据源
...
### <a name="connect-your-model-to-a-form"></a>向窗体连接您的模型
...
### <a name="make-the-properties-update-immediately"></a>请立即更新的属性
...
### <a name="provide-add-buttons"></a>提供添加按钮
