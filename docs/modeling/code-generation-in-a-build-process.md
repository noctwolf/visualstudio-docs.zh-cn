---
title: 在 Visual Studio 中的生成过程中的代码生成
ms.date: 03/22/2018
ms.topic: conceptual
helpviewer_keywords:
...
如果[您的生成服务器](http://msdn.microsoft.com/Library/788443c3-0547-452e-959c-4805573813a9)所在的计算机上运行[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]是未安装，在从开发计算机将以下文件复制到生成计算机。 用最新的版本号替换 ' *'。
...
在中**解决方案资源管理器**，选择**卸载**从你的项目的上下文菜单。 这允许你在 XML 编辑器中编辑 .csproj 或 .vbproj 文件。
...
在 MSBuild 中无法使用 visual Studio 宏 $ （solutiondir） 等。 你可以改用项目属性。
