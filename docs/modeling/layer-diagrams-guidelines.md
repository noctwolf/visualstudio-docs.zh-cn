...
##  <a name="Update"></a> 如何设计或更新您的应用程序的依赖项关系图
...
2.  [定义层以表示主功能区或组件](#CreateLayers)的应用程序。 按其功能命名这些层，例如“演示文稿”或“服务”。 如果有[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]解决方案，可以将每个层关联的集合*项目*，如项目、 命名空间、 文件和等等。
