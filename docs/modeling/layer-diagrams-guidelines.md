...
-   **显示可识别的体系结构模式**你依赖项关系图中，在可能的情况。 例如，描述桌面应用程序的依赖项关系图可能包括演示文稿、 域逻辑和数据存储等层。 介绍了应用程序的单个功能的依赖项关系图可能层如模型、 视图和控制器。 有关此类模式的详细信息，请参阅[模式和实践： 应用程序体系结构](http://go.microsoft.com/fwlink/?LinkId=145794)。
