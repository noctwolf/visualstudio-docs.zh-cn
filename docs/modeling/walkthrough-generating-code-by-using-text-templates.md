...
ms.locfileid: "53898081"
---
# <a name="walkthrough-generate-code-by-using-text-templates"></a>演练：通过使用文本模板生成代码
...
## <a name="develop-the-text-template"></a>开发文本模板
...
### <a name="run-the-test-program"></a>运行测试程序
