...
1. 打开“管理工具”窗口。  
   ...
   2.  在“控制面板”中，选择“切换到经典视图”，如果有必要，再双击“管理工具”。  
  
2. 在“管理工具”窗口中双击“Internet Information Services (IIS)管理器”。  
  
    IIS 管理器随即打开。  
  
3. 在“连接”窗格中，根据需要展开 \<计算机名称> 节点。  
  
4. 在 \<计算机名称> 节点下，单击“应用程序池”。  
  
5. 在“应用程序池”列表中，右键单击在其中运行应用程序的池的名称，再单击“高级设置”。  
  
6. 在“高级设置”对话框中，找到“进程模型”部分，然后执行下列操作之一：  
