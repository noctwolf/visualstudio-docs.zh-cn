...
1. 在 Visual Studio 中，依次选择“文件”>“新建”>“项目”。
    ...
    “创建新项目”对话框随即打开。 在搜索框中键入“asp.net”以筛选结果，选择“ASP.NET Core Web 应用程序”，然后单击“下一步”。 然后，输入名称（如“MyDbgApp”），然后选择“创建”。
    ::: moniker-end
    ::: moniker range="vs-2017"
    “新建项目”对话框随即打开。 在“Visual C++”下，选择“Windows 桌面”，然后在中间窗格中选择“Windows 控制台应用程序”。 然后，键入名称（如 MyDbgApp），然后单击“确定”。
    ::: moniker-end
