...
如果该操作失败，验证是否可通过网络访问远程计算机 ([ping](https://technet.microsoft.com/en-us/library/cc732509(v=ws.10).aspx)远程计算机)。 不支持通过 Internet 进行远程调试，某些 Microsoft Azure 的方案中除外。
