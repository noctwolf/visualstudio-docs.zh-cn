...
ms.locfileid: "62555036"
---
# <a name="customtype"></a>CustomType
通过供应商定义的类型 （特定于编译器的类型） 进行标识`SymTagCustomType`符号。
...
|[IDiaSymbol::get_type](../../debugger/debug-interface-access/idiasymbol-get-type.md)|`IDiaSymbol*`|第一种类型引用的自定义类型符号。|
|[IDiaSymbol::get_typeId](../../debugger/debug-interface-access/idiasymbol-get-typeid.md)|`DWORD`|类型符号的 ID。|
|[IDiaSymbol::get_types](../../debugger/debug-interface-access/idiasymbol-get-types.md)|`IDiaSymbol**`|引用的自定义类型符号的所有类型的数组。|
