---
title: "生成 XML 文档注释的代码生成 (C#) |Microsoft 文档"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="generate-xml-documentation-comments-in-c"></a>在 C# 中生成 XML 文档注释 #
...
1. 接下来，键入 **///**  （3 步正斜杠） 将用于根据需要自动创建基模板和任何其他元素。  例如，如果注释方法，它将生成**\<摘要\>**标记以及 **\<param\>** 的是每个参数的标记传递给方法，和一个**\<返回\>**以记录该方法返回的标记。
