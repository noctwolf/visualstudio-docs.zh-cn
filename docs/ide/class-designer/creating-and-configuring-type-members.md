...
默认情况下，打开一个新的类图时，“类详细信息”窗口会自动显示（请参阅[如何：将类图添加到项目中](how-to-add-class-diagrams-to-projects.md)）。 你也可以通过以下方式明确地打开“类详细信息”窗口。
