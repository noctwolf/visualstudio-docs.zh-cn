...
### [快速入门：创建 Visual Basic 控制台应用程序](../ide/quickstart-visual-basic-console.md)
...
#### [代码样式首选项](code-styles-and-quick-actions.md)
...
#### [搜索表达式中的逻辑和高级运算符](logical-operators-in-search-expressions.md)
