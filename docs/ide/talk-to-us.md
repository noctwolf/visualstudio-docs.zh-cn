...
请使用我们位于页面底部的“此页面是否有所帮助?”反馈按钮。 所有我们的文档页面上都有这个按钮。 或者，可以使用 GitHub 帐户将反馈添加到 [docs.microsoft.com](https://docs.microsoft.com/visualstudio/) 处的任何 Visual Studio 页；选择同样位于页面底部的“发送相关反馈” > “本页”按钮。
