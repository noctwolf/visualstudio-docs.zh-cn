...
* [Visual F# Power Tools](https://marketplace.visualstudio.com/items?itemName=FSharpSoftwareFoundation.VisualFPowerTools)&mdash;此第三方 Visual Studio 扩展中提供了对 F# 的重构支持。
