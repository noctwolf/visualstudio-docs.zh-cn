---
title: "快速入门：使用 Visual Studio 创建第一个 ASP.NET Core web 应用 | Microsoft Docs"
ms.custom: 
ms.date: 10/10/2017
ms.reviewer: 
ms.suite: 
...
[通过 Visual Studio 开始使用 C# 和 Visual Basic](getting-started-with-visual-csharp-and-visual-basic.md)
