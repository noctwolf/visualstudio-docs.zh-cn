...
2. 由于该代码引用 `Automobile` 上未定义的两个属性，所以 `Model` 和 `TopSpeed` 下将显示波浪形下划线。 将鼠标悬停在 `Model` 上，选择“快速操作”灯泡，然后选择“生成属性 'Automobile.Model'”。
...
2.  单击红色波形线下的“快速操作”灯泡，然后单击“在 'Automobile' 中生成构造函数”。
...
2.  单击 `myAuto.Start` 方法调用的“快速操作”灯泡，然后单击“生成方法 'Automobile.Start'”。
