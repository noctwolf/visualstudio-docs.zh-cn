...
使用与 Microsoft 帐户或者工作或学校帐户相关联的 Visual Studio 订阅或 Azure DevOps Services 组织解锁 Visual Studio：

1. 单击 IDE 右上角的“登录”按钮（或转到“文件” > “帐户设置”，打开“帐户设置”对话框，然后单击"登录"按钮）。

1. 对 Microsoft 帐户、工作或学校帐户输入凭据。 Visual Studio 将查找与帐户相关联的 Visual Studio 订阅或 Azure DevOps Services 组织。

> [!IMPORTANT]
> 当连接到“团队资源管理器”工具窗口的 Azure DevOps Services 组织时，Visual Studio 将自动查找相关联的在线订阅。 当连接到 Azure DevOps Services 组织时，可以使用 Microsoft 帐户和工作或学校帐户登录。 如果该用户帐户有在线订阅，则 Visual Studio 将自动为你解锁 IDE。
