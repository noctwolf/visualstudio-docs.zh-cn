---
title: "Visual Studio 概述 | Microsoft Docs"
ms.custom: 
ms.date: 11/09/2017
ms.reviewer: 
ms.suite: 
...
1. “新建项目”对话框中会显示几个项目模板。 在“Visual C#”下选择“Windows Universal”类别，再选择“空白应用(通用 Windows)”模板，然后选择“确定”按钮。
  ...
  > [!NOTE]
  > 如果看不到“Windows 通用”类别，需要安装“通用 Windows 平台开发”工作负载。 为此，选择“新建项目”对话框左下角的“打开 Visual Studio 安装程序”链接。 在“Visual Studio 安装程序”打开后，依次选择“通用 Windows 平台开发”工作负载和“修改”。
...
1. 现在启动该应用。 为此，可以选择工具栏上的“开始”按钮 (![“开始”按钮](../ide/media/VSIDE_StartButton.png))，也可以按 F5 键，亦可以在菜单上依次选择“调试” > “开始调试”。
