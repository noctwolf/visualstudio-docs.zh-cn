    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/visualstudio/ide/class-view-and-object-browser-icons">“类视图”和“对象浏览器”图标</a></p>
                        <p><a href="/visualstudio/ide/reference/visual-studio-reference">Visual Studio 参考</a></p>
                    </div>
                </div>
            </div>
        </div>
