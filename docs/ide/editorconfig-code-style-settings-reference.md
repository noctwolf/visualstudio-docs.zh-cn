---
title: Visual Studio 中 EditorConfig 的 .NET 编码约定设置
ms.date: 06/14/2018
ms.topic: reference
dev_langs:
- CSharp
...
- 如果将此规则设置为 true，则首选自动属性，而非具有专用支持字段的属性。
- 如果将此规则设置为 false，则首选具有专用支持字段的属性，而非自动属性。
