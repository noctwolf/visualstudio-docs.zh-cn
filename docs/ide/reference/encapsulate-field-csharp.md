---
title: "将字段重构为属性 (C#) | Microsoft Docs"
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="encapsulate-a-field-in-c"></a>封装字段 (C#) #
...
1. 突出显示要封装的字段的名称，或将文本光标置于其中：
   ...
   ![突出显示的代码](media/encapsulate-highlight-cs.png)
...
1. 接下来，执行以下操作之一：
   ...
   * **鼠标**
   ...
   ![“封装属性”的结果](media/encapsulate-result-cs.png)
