...
1. 在两个组合框中，将“Msbuild 项目生成详细程度”  设置为“详细”  。 上面的组合框控制输出窗口  中的生成详细程度，第二个组合框控制生成期间在每个项目的 Intermediate 目录中创建的 \<projectname\>.log 文件中的生成详细程度。
1. 从 Visual Studio 开发人员命令提示符中，输入以下命令之一，替换你的实际路径和配置值：
