...
## <a name="experience-visual-studio-with-5-minute-quickstarts"></a>通过 5 分钟“快速入门”体验 Visual Studio
...
## <a name="go-deeper-with-tutorials"></a>通过教程深入了解
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>调试</span></a></div>