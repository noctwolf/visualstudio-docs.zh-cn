...
若要隐藏导航栏，请在“文本编辑器”的“所有语言”设置中更改“导航栏”选项（依次选择“工具”、“选项”、“文本编辑器”和所有语言”），也可以单独更改各语言的设置。  
...
通过“转到定义”，可转到所选元素的定义。 有关详细信息，请参阅[“转到定义”和“查看定义”](../ide/go-to-and-peek-definition.md)。  
