...
-   如果用户打开一个图片文件，则程序将在<xref:System.Windows.Forms.PictureBox> 中显示该图片。  
 ...
 ![视频链接](../data-tools/media/playvideo.gif "PlayVideo")有关本主题的视频版本，请观看[教程 1：用 Visual Basic 创建图片查看器 - 视频 4](http://go.microsoft.com/fwlink/?LinkId=205215) 或 [教程 1：用 C# 创建图片查看器 - 视频 4](http://go.microsoft.com/fwlink/?LinkId=205203)。 这些视频使用 Visual Studio 的早期版本，因此在一些菜单命令和其他用户界面元素上略有差异。 但是，概念和过程与当前版本的 Visual Studio 大同小异。  
