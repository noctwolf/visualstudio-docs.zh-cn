...
使用 [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)] 可为执行系统或人工流程创建工作流。 Windows 工作流设计器提供用于创建这些工作流设计图面。 [!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)] 可用于在 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 内创建工作流，也可集成到重新承载该设计器的其他应用程序。
