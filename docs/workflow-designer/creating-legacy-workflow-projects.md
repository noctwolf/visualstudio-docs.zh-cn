...
ms.locfileid: "31969799"
---
# <a name="creating-legacy-workflow-projects"></a>创建旧版工作流项目

本部分介绍如何创建工作流项目使用由 Visual Studio 2010 提供的旧 Windows 工作流设计器。 旧工作流设计器面向.NET Framework 版本 3.5 或 WinFX。 它包括有关如何使用下表所列出的工作流项目模板的信息。
