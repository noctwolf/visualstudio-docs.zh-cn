...
本主题介绍如何使用中的主题[!INCLUDE[wf](../workflow-designer/includes/wf_md.md)]时使用旧的 Windows 工作流设计器面向[!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)]或[!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)]。
