...
ms.locfileid: "31927028"
---
# <a name="model-editor"></a>模型编辑器

本文档介绍如何使用 Visual Studio 模型编辑器查看、创建和修改三维模型。

可以使用模型编辑器从头开始创建基本的三维模型，或查看和修改使用全功能三维建模工具创建的更为复杂的三维模型。 模型编辑器支持用于 DirectX 应用程序开发的若干三维模型格式。
...
### <a name="begin-your-3d-model"></a>开始编辑三维模型
...
## <a name="work-with-the-model-editor"></a>使用模型编辑器
...
![模型查看器模式工具栏。](../designers/media/digit-mre-modal-toolbar.png)
...
### <a name="control-the-view"></a>控制视图
...
为更好地了解三维对象或场景，可以查看其他几何详细信息，例如每个顶点的法向、每个面的法向、活动选择项的透视点和其他详细信息。 要启用或禁用它们，请在“模型编辑器”工具栏上，选择“脚本”->“查看”，然后根据需要选择一个选项。

### <a name="create-and-import-3d-objects"></a>创建并导入三维对象
