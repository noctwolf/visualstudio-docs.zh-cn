...
|标题|描述|  
|-----------|-----------------|  
|[为游戏和应用使用三维资产](../designers/working-with-3-d-assets-for-games-and-apps.md)|概述你可以用来处理图形资产（例如纹理和图像、三维模型和着色器效果）的 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 工具。|  
