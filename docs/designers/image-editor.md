...
|**红色通道**<br /><br /> **绿色通道**<br /><br /> **蓝色通道**<br /><br /> **Alpha 通道**|启用或禁用特定颜色通道。 **注意：** 通过系统地启用或禁用颜色通道，可隔离与其中一个或多个通道有关的问题。 例如，可识别出不正确的 Alpha 透明度。|
