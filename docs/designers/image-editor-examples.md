...
|[在游戏或应用程序中使用三维资产](../designers/using-3-d-assets-in-your-game-or-app.md)|介绍如何在构建项目或解决方案时使用 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 处理 3-D 资产，以便在应用中随时使用它们。 此外，还讨论了将不同种类的资产加载到应用中的其他策略。|  
