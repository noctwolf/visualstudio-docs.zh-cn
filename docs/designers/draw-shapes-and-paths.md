...
### <a name="draw-a-straight-line"></a>绘制直线
 使用“笔”  工具 ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)或“线条”  工具 ![](../designers/media/eb618397-5283-48be-8396-3449be7b6fbf.png)。

 **使用“笔”工具** ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)

 在美工板上，单击一次以定义开始点，然后再次单击以定义线条末尾。

 **使用“线条”工具** ![](../designers/media/eb618397-5283-48be-8396-3449be7b6fbf.png)
...
### <a name="change-the-shape-of-a-curve"></a>更改曲线的形状
 使用“路径选择”  工具 ![](../designers/media/6dd6571f-c116-451d-8dd2-1f88b8406362.png)。

 单击形状，然后拖动形状上的任何点以更改曲线形状。

### <a name="draw-a-free-form-path"></a>绘制任意形状的路径
 使用“铅笔”  工具 ![](../designers/media/509dc167-734f-46c9-b012-987ee63450cd.png)。
...
### <a name="remove-a-point-in-a-path"></a>删除路径中的点
 使用“选择”  工具  ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png)和“笔”  工具 ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)。

 使用“选择”  工具  ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png) ，以选中路径。 然后，使用“笔”  工具 ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png) ，以单击想要删除的点。

### <a name="add-a-point-to-a-path"></a>向路径添加点
 使用“选择”  工具  ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png)和“笔”  工具 ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)。

 使用“选择”  工具  ![](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png) ，以选中路径。 使用“笔”  工具 ![](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png) ，以单击想要在其中添加点的路径上的任意位置。
...
|||||
|-|-|-|-|
|![](../designers/media/b1_1.png)|合并之前的两个形状|![](../designers/media/b1_4.png)|相交|
|![](../designers/media/b1_2.png)|相并|![](../designers/media/b1_5.png)|排除重叠|
|![](../designers/media/b1_3.png)|除|![](../designers/media/b1_6.png)|减|
