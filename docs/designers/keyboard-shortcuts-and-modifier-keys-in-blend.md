...
-   访问键 可以使用访问键，即通过按键盘上的特定键来访问菜单命令或对话框中的某个区域。 访问键由当前选定命令或对话框中显示的下划线标识。
     ...
     ![访问键](../designers/media/441d5d67-48ee-4ba3-9e55-1826167e8d64.png) 按 Alt 后显示的带下划线的访问键。
...
-   快捷键 可以使用快捷键，即通过按键盘快捷方式来执行操作（例如选择菜单命令或修改工具的行为）。
     ...
     ![示例快捷键](../designers/media/f147fc85-9fc5-4e8a-8039-bead80a3e595.png) 显示在具有快捷方式的菜单项旁边的快捷键。
