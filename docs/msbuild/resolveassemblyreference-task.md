...
|`FullFrameworkFolders`|可选 <xref:System.String?displayProperty=fullName>`[]` 参数。<br /><br /> 指定包含 RedistList 目录的文件夹。 此目录表示给定客户端配置文件的完整框架，例如 %programfiles%\reference assemblies\microsoft\framework\v4.0。|
