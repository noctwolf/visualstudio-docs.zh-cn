...
- 从 Visual Studio 2013 开始，可以在“MSBuild”文件夹中查找 MSBuild.exe（32 位操作系统上的 %ProgramFiles%\MSBuild，或者 64 位操作系统上的 %ProgramFiles(x86)%\MSBuild）。
...
## <a name="use-the-project-file-to-build-the-application"></a>使用项目文件生成应用程序
