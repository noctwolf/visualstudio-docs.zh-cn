...
## <a name="you-have-re-targeted-a-project-to-a-different-version-of-the-net-framework"></a>已将项目重新面向不同版本的 .NET Framework
 如果更改应用程序的 .NET Framework 的目标版本，则 Visual Studio 将更改某些引用，并可能需要手动更新某些引用。 例如，如果将应用程序更改为面向 [!INCLUDE[net_v35SP1_long](../msbuild/includes/net_v35sp1_long_md.md)]，并且该应用程序具有依赖于 .NET Framework 4 的客户端配置文件的资源或设置，则可能出现先前提到的某个错误。
