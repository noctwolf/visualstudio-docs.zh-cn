---
title: "在 Linux 上设置远程 R 服务| Microsoft Docs"
ms.custom: 
ms.date: 12/04/2017
ms.reviewer: 
ms.suite: 
...
适用于 Linux 的远程 R 服务当前打包为 rtvs-daemon。 Ubuntu 16.04、16.10 LTS 桌面、服务器和适用于 Linux 的 Windows 子系统（运行 Ubuntu）系统上支持守护程序，并在系统上对守护程序进行了测试。 本主题的大部分内容都是在这些不同系统上设置远程 R 服务的说明。
...
1. 按照 [Windows 10](https://msdn.microsoft.com/commandline/wsl/install-win10) 或 [Windows Server](https://msdn.microsoft.com/en-us/commandline/wsl/install-on-server) 的 WSL 安装说明操作。
