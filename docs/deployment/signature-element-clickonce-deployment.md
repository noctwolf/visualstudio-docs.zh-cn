...
## <a name="remarks"></a>备注  
 通过封装签名的部署清单签名是可选的但建议。 有关签名 XML 文件的详细信息，请参阅万维网联合会建议，"XML 签名语法和处理，"中所述[ http://www.w3.org/TR/xmldsig-core/ ](http://www.w3.org/TR/xmldsig-core/)。  
