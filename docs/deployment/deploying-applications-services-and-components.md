...
在团队环境中，可以使用 Visual Studio Team Services (VSTS) 以启用对应用程序的持续部署。 有关详细信息，请参阅[生成和发布](/vsts/build-release/index)并[部署到 Azure](/vsts/deploy-azure/index)。
...
| **LightSwitch** | LightSwitch 在 Visual Studio 2017 中，不再受支持，但仍然可以从 Visual Studio 2015 及更早版本部署。 | [部署 LightSwitch 应用程序](http://msdn.microsoft.com/Library/4818d933-295c-4ecc-9148-7ad9ca28dcdb) | 
