...
## <a name="trust-center-settings-in-the-microsoft-office-system-do-not-affect-add-ins-or-document-level-customizations"></a>Microsoft Office system 中的信任中心设置不影响外接程序或文档级自定义项  
