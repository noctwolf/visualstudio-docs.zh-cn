---
title: "使用 Word 的演练 |Microsoft 文档"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="application-level-walkthroughs"></a>应用程序级演练  
 ...
 演示如何使用 VSTO 外接程序中的 XML 说明符文件创建自定义功能区选项卡。  
