---
title: "Office UI 自定义演练 |Microsoft 文档"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="controls-on-word-documents"></a>Word 文档中的控件  
 [演练：运行时在 VSTO 外接程序中将控件添加到文档](../vsto/walkthrough-adding-controls-to-a-document-at-run-time-in-a-vsto-add-in.md)  
...
## <a name="controls-on-excel-worksheets"></a>Excel 工作表中的控件  
