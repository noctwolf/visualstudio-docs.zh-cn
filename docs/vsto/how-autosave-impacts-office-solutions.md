...
注意： 为 Windows 桌面 Word、 Excel 和 PowerPoint 的自动保存在 2017 年 1 中引入了和当前可用于 Office365 订户。 买到 Office 2016 或更早版本的永久许可证的用户当前不具有访问提供共同编写功能。 （Excel Online，适用于 Android 的 Excel，对于 iOS，Excel 和 Windows 应用商店中的 Excel 移动也支持自动保存）。 
