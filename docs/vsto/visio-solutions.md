...
-   将外部数据导入 Visio，将其链接到形状并在页面上以图形方式显示。  
 ...
 你可以查看分步过程和代码示例使用 Visio 对象模型处理文档和形状中的[处理的 Visio 文档](../vsto/working-with-visio-documents.md)和[使用 Visio 形状](../vsto/working-with-visio-shapes.md)。  
...
## <a name="visio-object-model-overview"></a>Visio 对象模型概述  
 你可以找到在 Visio 对象模型的概述[Visio 对象模型概述](../vsto/visio-object-model-overview.md)，其中包括指向 Visio 对象模型参考和 Sdk。  
