...
# <a name="how-to-add-xmlnode-controls-to-word-documents"></a>如何： 向 Word 文档添加 XMLNode 控件
 ...
 当非重复的 XML 架构元素映射到 Microsoft Office Word 文档时，Visual Studio 会自动添加<xref:Microsoft.Office.Tools.Word.XMLNode>到你的文档的控件。 有关映射重复的 XML 架构元素的信息，请参阅[如何： 添加 XMLNodes 控件添加到 Word 文档](../vsto/how-to-add-xmlnodes-controls-to-word-documents.md)。  
