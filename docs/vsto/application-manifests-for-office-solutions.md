...
|[&#60;entryPoint&#62;元素&#40;ClickOnce 应用程序&#41;](../deployment/entrypoint-element-clickonce-application.md)|必需。 标识用于执行的应用程序代码入口点。|**name**<br /><br /> **dependencyName**<br /><br /> **p o i**|
...
## <a name="remarks"></a>备注
 可以在 Office 解决方案中手动编辑应用程序和部署清单。 此后，必须重新签名应用程序和部署清单通过使用清单生成和编辑工具 (*mage.exe*并*mageui.exe*)。 有关更多信息，请参见[如何：应用程序和部署清单重新签名](../deployment/how-to-re-sign-application-and-deployment-manifests.md)。
