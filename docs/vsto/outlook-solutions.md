...
## <a name="outlook-vsto-add-in-programming-model"></a>Outlook VSTO 外接程序编程模型  
 ...
 有关详细信息`ThisAddIn`类和其他功能，你可以使用在 VSTO 外接程序中，请参阅[程序 VSTO 外接程序](../vsto/programming-vsto-add-ins.md)。  
...
|[演练： 创建第一个 VSTO 外接程序的 Outlook](../vsto/walkthrough-creating-your-first-vsto-add-in-for-outlook.md)|显示如何为 Microsoft Office Outlook 创建 VSTO 外接程序。|  
