...
### <a name="creating-custom-user-controls"></a>创建自定义用户控件  
...
### <a name="arranging-controls-at-design-time"></a>在设计时排列控件  
...
### <a name="matching-control-size-to-cell-size-on-an-excel-worksheet"></a>在 Excel 工作表中使控件大小与单元格大小匹配  
...
### <a name="formula-for-embedding-controls-on-an-excel-worksheet"></a>用于在 Excel 工作表中嵌入控件的公式  
...
### <a name="layout-style-of-controls-on-a-word-document"></a>Word 文档中控件的布局样式  
 ...
 当在运行时向 Word 文档添加控件时，你可以使用不同指定新的控件的布局样式`Add` \<*控件类*> 方法重载的<xref:Microsoft.Office.Tools.Word.ControlCollection>类：  
...
### <a name="adding-components-at-design-time"></a>在设计时添加组件  
...
## <a name="see-also"></a>请参阅  
 ...
 [演练： 更改文档格式使用复选框控件](../vsto/walkthrough-changing-document-formatting-using-checkbox-controls.md)   
 ...
 [Office 文档上的 Windows 窗体控件的限制](../vsto/limitations-of-windows-forms-controls-on-office-documents.md)   
 [演练： 更新使用单选按钮在文档的图表](../vsto/walkthrough-updating-a-chart-in-a-document-using-radio-buttons.md)   
