...
注意： 共同编写的 Windows 桌面 Excel 在 2017年中引入，目前适用于 office 365 订阅者。 购买到 Office 2016 或更早版本的永久许可证用户当前不具有访问共同编写功能。 （Excel Online，适用于 Android 的 Excel，适用于 iOS、 Excel 和 Windows 应用商店中的 Excel Mobile 还支持共同编写）。
