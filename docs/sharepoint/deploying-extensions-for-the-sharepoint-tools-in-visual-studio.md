...
7.  再次，打开项目节点的快捷菜单，然后选择**编辑***YourTemplateProjectName***.csproj**或**编辑***YourTemplateProjectName***。vbproj**。
