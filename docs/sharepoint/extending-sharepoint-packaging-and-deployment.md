...
## <a name="run-code-when-a-sharepoint-solution-is-deployed-or-retracted"></a>部署或收回 SharePoint 解决方案时运行代码
...
## <a name="run-command-line-operations-before-or-after-a-project-is-deployed"></a>运行命令行操作之前或之后部署项目
