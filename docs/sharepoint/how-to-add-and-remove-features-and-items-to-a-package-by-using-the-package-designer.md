...
ms.locfileid: "34767143"
---
# <a name="how-to-add-and-remove-features-and-items-to-a-package-by-using-the-package-designer"></a>如何： 添加和移除功能和包项使用包设计器
...
#### <a name="to-add-sharepoint-features-with-the-package-designer"></a>若要添加具有在包设计器的 SharePoint 功能
...
#### <a name="to-remove-sharepoint-features-with-the-package-designer"></a>若要删除具有在包设计器的 SharePoint 功能
