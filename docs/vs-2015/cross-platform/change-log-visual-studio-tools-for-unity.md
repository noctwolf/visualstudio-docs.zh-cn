...
ms.locfileid: "47482126"
---
# <a name="change-log-visual-studio-tools-for-unity"></a>更改日志（Visual Studio Tools for Unity）
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[更改日志 (Visual Studio Tools for Unity)](https://docs.microsoft.com/visualstudio/cross-platform/change-log-visual-studio-tools-for-unity)。  
