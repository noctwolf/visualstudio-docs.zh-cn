...
## <a name="related-sections"></a>相关章节  
 [使用 Visual Studio SDK 针对测试进行自定义](http://msdn.microsoft.com/9cf7a840-dd66-4b00-90f7-e00e40370a69)  
 描述可以如何扩展 [!INCLUDE[vsprvstte](../includes/vsprvstte-md.md)] 以支持新类型的测试。  
  
 [Visual Studio 集成测试](http://msdn.microsoft.com/8d741735-7d93-46c2-ab93-01da7a0e016d)  
