...
ms.locfileid: "47588751"
---
# <a name="cl-task"></a>CL 任务
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CL 任务](https://docs.microsoft.com/visualstudio/msbuild/cl-task)。  
...
-   **IntrinsicFunctions**  
     ...
     有关详细信息，请参阅 [/Oi （生成内部函数）](http://msdn.microsoft.com/library/fa4a3bf6-0ed8-481b-91c0-add7636132b4)。  
...
-   **PreprocessorDefinitions**  
     ...
     有关详细信息，请参阅 [/D（预处理器定义）](http://msdn.microsoft.com/library/b53fdda7-8da1-474f-8811-ba7cdcc66dba)。  
...
-   **UseFullPaths**  
     ...
     有关详细信息，请参阅 [/FC（所诊断源代码文件的完整路径）](http://msdn.microsoft.com/library/1f11414e-cb42-421b-be68-9d369aab036b)。  
