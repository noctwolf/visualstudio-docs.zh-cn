...
> [!IMPORTANT]
>  应将必备组件安装程序的包添加到开发计算机中，然后发布您的第一个[!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)]应用程序。 有关详细信息，请参阅[如何： 与 ClickOnce 应用程序包括先决条件](../deployment/how-to-include-prerequisites-with-a-clickonce-application.md)。  
