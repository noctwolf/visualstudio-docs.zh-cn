...
|[项目设计器简介](http://msdn.microsoft.com/898dd854-c98d-430c-ba1b-a913ce3c73d7)|概述可集中管理项目属性、设置和资源的项目设计器。|
...
|[如何：添加到应用程序配置文件C#项目](../csharp-ide/how-to-add-an-application-configuration-file-to-a-csharp-project.md)|描述如何向 C# 项目中添加配置文件 (app.config)。|
