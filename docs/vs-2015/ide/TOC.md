...
#### [演练：创建简单应用程序](walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic.md)
...
#### [如何：查找和组织模板](how-to-locate-and-organize-project-and-item-templates.md)
...
#### [如何：还原 C# 重构代码片段](how-to-restore-csharp-refactoring-snippets.md)
...
#### [Visual Studio 命令别名](reference/visual-studio-command-aliases.md)
