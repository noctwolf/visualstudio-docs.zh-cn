...
ms.locfileid: "47484518"
---
# <a name="javascript-intellisense"></a>JavaScript IntelliSense
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[JavaScript IntelliSense](https://docs.microsoft.com/visualstudio/ide/javascript-intellisense)。  
...
##  <a name="ProcessingIntelliSenseInformation"></a> 处理 IntelliSense 信息  
 若要提供 JavaScript IntelliSense，语言服务，请执行以下操作：  
...
###  <a name="IntrinsicObjects"></a> 内部对象  
 JavaScript IntelliSense 为 `Array`、`String`、`Math`、`Date` 和 `Number` 等内部对象提供编程引用。 有关内部对象的详细信息，请参阅[内部对象](~/E:/Repos/visualstudio-docs-pr/scripting-docs/javascript/intrinsic-objects-javascript.md)。  
  
###  <a name="UserDefined"></a> 用户定义的变量、 函数和对象  
 更改 JavaScript 文件时，[!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] 将扫描打开和引用的文档，以确定所有可用的代码资源。 这包括变量、 函数和已创建的对象。 然后 JavaScript IntelliSense 便可使用这些资源。  
  
 有关用户定义的变量、 函数和对象的详细信息，请参阅[创建自己的对象](http://go.microsoft.com/fwlink/?LinkId=108671)MSDN 网站上。  
...
####  <a name="ReferenceDirectives"></a> Reference 指令  
...
-   **错误列表**窗口。 **错误列表**窗口会显示错误说明、 发生错误的文件、 行和列号和项目。 若要显示**错误列表**窗口，请在**视图**菜单中，单击**错误列表**。  
...
## <a name="see-also"></a>请参阅  
 ...
 [列表成员](http://msdn.microsoft.com/en-us/1b9cc469-9cd4-4d42-9999-1f9479635ff8)   
