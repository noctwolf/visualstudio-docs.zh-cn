...
```  
 ...
 有关使用 `typedef` 类型的详细信息，请参阅 [(NOTINBUILD)typedef 说明符](http://msdn.microsoft.com/cc96cf26-ba93-4179-951e-695d1f5fdcf1)。  
...
## <a name="see-also"></a>请参阅  
 ...
 [(NOTINBUILD)typedef 说明符](http://msdn.microsoft.com/cc96cf26-ba93-4179-951e-695d1f5fdcf1)
