---
title: 步骤 8：为显示图片按钮事件处理程序编写代码 |Microsoft Docs
ms.date: 11/15/2016
...
- 如果用户打开一个图片文件，则程序将在 PictureBox 中显示该图片。  
  ...
  ![视频链接](../data-tools/media/playvideo.gif "播放视频")本主题的视频版本，请参阅[教程 1:在 Visual Basic-视频 4 中创建图片查看器](http://go.microsoft.com/fwlink/?LinkId=205215)或[教程 1:创建图片查看器中的C#-视频 4](http://go.microsoft.com/fwlink/?LinkId=205203)。 这些视频使用 Visual Studio 的早期版本，因此在一些菜单命令和其他用户界面元素上略有差异。 但是，概念和过程与当前版本的 Visual Studio 大同小异。  
...
- 要转到下一个教程步骤，请参阅[步骤 9：查看、 添加注释，和测试你的代码](../ide/step-9-review-comment-and-test-your-code.md)。  
