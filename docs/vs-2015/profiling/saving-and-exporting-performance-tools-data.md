...
ms.locfileid: "47468487"
---
# <a name="saving-and-exporting-performance-tools-data"></a>保存和导出性能工具数据
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[保存和导出性能工具数据](https://docs.microsoft.com/visualstudio/profiling/saving-and-exporting-performance-tools-data)。  
...
5.  下**报告导出格式**，选择 （逗号分隔） (*.csv) 或 XML 数据 (\*.xml)。  
...
7.  下**报告导出格式**，选择 （逗号分隔） (*.csv) 或 XML 数据 (\*.xml)。  
