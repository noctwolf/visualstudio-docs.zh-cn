...
本主题的最新版本，请参阅[从 ASP.NET Web 应用程序使用 Profiler 命令行收集内存数据](https://docs.microsoft.com/visualstudio/profiling/collecting-memory-data-from-an-aspnet-web-application-by-using-the-profiler-command-line)。  
