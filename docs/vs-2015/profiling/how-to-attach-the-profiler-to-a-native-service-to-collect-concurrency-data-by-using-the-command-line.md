...
本主题的最新版本，请参阅[如何： 使用命令行附加到本机服务以收集并发数据 Profiler](https://docs.microsoft.com/visualstudio/profiling/how-to-attach-the-profiler-to-a-native-service-to-collect-concurrency-data-by-using-the-command-line)。  
