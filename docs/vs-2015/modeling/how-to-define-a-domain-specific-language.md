...
### <a name="test-the-solution"></a>测试解决方案  
 ...
 如果运行一个解决方案创建从**最小语言**模板，在实验性[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]将类似于下面的示例：  
...
3. **打开资源管理器。** 在关系图的一端是语言资源管理器窗口中，通常名为*YourLanguage*资源管理器。 如果未看见此窗口，则它可能位于“解决方案资源管理器”下方的选项卡上。 如果找不到它，在**视图**菜单，依次指向**其他 Windows**，然后单击_YourLanguage_**资源管理器**。  
 ...
 **此关系的允许重复属性设置**如果同一对模型元素之间可以存在多个链接相同的类。 例如，可以允许 Teacher 向相同的 Student 教授多个 Subject。  
 ...
 ![形状映射的连接器](../modeling/media/music-connector.png "Music_Connector")  
...
## <a name="compartments"></a> 定义包含列表的：隔离舱形状  
 ...
 ![形状地图](../modeling/media/music-mapcomp.png "Music_MapComp")  
