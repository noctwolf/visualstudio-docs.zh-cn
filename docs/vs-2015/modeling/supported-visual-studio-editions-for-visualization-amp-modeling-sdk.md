---
title: 支持的可视化效果 Visual Studio 版本&amp;建模 SDK |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47477339"
---
# <a name="supported-visual-studio-editions-for-visualization-amp-modeling-sdk"></a>支持的可视化效果 Visual Studio 版本&amp;建模 SDK
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[可视化效果的支持 Visual Studio 版本&amp;建模 SDK](https://docs.microsoft.com/visualstudio/modeling/supported-visual-studio-editions-for-visualization-amp-modeling-sdk)。  
  
以下是支持与 Visual Studio 版本的列表[!INCLUDE[dsl](../includes/dsl-md.md)]中创作和部署环境。 这些版本的详细信息，请参阅 Microsoft [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [开发人员中心](http://go.microsoft.com/fwlink/?LinkId=75628)。  
