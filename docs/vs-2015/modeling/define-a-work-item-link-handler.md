...
### <a name="project-references"></a>项目引用  
 ...
 `System.Drawing` -使用的示例代码  
  
 如果找不到在下，这些引用之一 **.Net**选项卡**添加引用**对话框中，使用浏览选项卡中 \Program Files\Microsoft Visual Studio [version] \Common7\IDE\ 找到它PrivateAssemblies\\。  
  
### <a name="import-the-work-item-namespace"></a>导入工作项命名空间  
 在你[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]项目**引用**，添加对以下程序集的引用：  
