...
本主题的最新版本，请参阅[如何： 映射到存储的过程和函数 （O-R 设计器） 创建 DataContext 方法](https://docs.microsoft.com/visualstudio/data-tools/how-to-create-datacontext-methods-mapped-to-stored-procedures-and-functions-o-r-designer)。  
