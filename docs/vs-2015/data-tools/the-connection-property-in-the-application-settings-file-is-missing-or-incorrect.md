...
应用程序设置文件中缺少连接属性或连接属性不正确。 已使用 .dbml 文件中的连接字符串来替代它。  
 ...
 .dbml 文件包含对应用程序设置文件中某连接字符串的引用，但无法找到该连接字符串。 此消息仅供参考;连接字符串设置将创建何时**确定**单击。  
...
## <a name="see-also"></a>请参阅  
 ...
 [NIB： 如何： 添加或删除应用程序设置](http://msdn.microsoft.com/en-us/a233965c-126d-46ab-add4-efb758f576f4)   
