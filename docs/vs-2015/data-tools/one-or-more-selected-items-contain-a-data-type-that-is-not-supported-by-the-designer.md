...
本主题的最新版本，请参阅[一个或多个选定的项包含设计器不支持的数据类型](https://docs.microsoft.com/visualstudio/data-tools/one-or-more-selected-items-contain-a-data-type-that-is-not-supported-by-the-designer)。  
