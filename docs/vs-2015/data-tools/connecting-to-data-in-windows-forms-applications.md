...
|操作|描述|  
|------------|-----------------|  
|运行[数据源配置向导](http://msdn.microsoft.com/library/c4df7de5-5da0-4064-940c-761dd6d9e28f)。|在选择的数据库路径时，将配置连接**数据源配置向导**。 有关详细信息，请参阅[如何： 连接到数据库中的数据](../data-tools/how-to-connect-to-data-in-a-database.md)。|  
