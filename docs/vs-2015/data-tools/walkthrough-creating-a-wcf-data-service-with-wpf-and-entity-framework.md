...
本主题的最新版本，请参阅[演练： 使用 WPF 和 Entity Framework 创建 WCF 数据服务](https://docs.microsoft.com/visualstudio/data-tools/walkthrough-creating-a-wcf-data-service-with-wpf-and-entity-framework)。  
