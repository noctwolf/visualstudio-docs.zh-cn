...
本主题的最新版本，请参阅[使用 Visual Studio 静态代码分析应用商店应用程序分析 c + + 代码质量](https://docs.microsoft.com/visualstudio/test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis)。  
