 ...
 **Visual Studio 中：** 在 “工具” 菜单上，指向 **“选项”** ，然后依次选择 **“文本编辑器”**、 **“XAML”** 和 **“其他”**。  
 ...
 **为现有控件指定唯一名称的具体步骤**  
 ...
 ![选择“工具”菜单中的“命名交互元素”](../test/media/cuit-windowsstoreproperty-blend-1.png "CUIT_WindowsStoreProperty_Blend_1")  
  
 **自动为创建的控件指定唯一名称的具体步骤**  
  
 在“工具”菜单上，指向“选项”，然后选择“项目”。 选中“在创建时自动命名交互元素”，然后选择“确定”，如下图所示：  
  
 ![将项目设为命名交互元素](../test/media/cuit-windowsstoreproeprty-blend-2.png "CUIT_WindowsStoreProeprty_Blend_2")  
