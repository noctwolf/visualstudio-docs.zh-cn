---
title: 分析应用商店应用程序使用 Visual Studio 静态代码分析的代码质量 |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
本主题的最新版本，请参阅[来分析应用商店应用程序使用 Visual Studio 静态代码分析的代码质量](https://docs.microsoft.com/visualstudio/test/analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis)。  
