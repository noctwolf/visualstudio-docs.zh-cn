...
1. 通过再次运行测试来验证现在测试是数据驱动的。  
   ...
   **指南**  
   ...
   有关其他信息，请参阅[对使用 Visual Studio 2012 – Chapter 2 的连续交付进行测试：单元测试：测试内部](http://go.microsoft.com/fwlink/?LinkID=255188)和[测试持续交付使用 Visual Studio 2012 – 第 5 章：实现系统测试的自动化](http://go.microsoft.com/fwlink/?LinkID=255196)  
...
### <a name="q-can-i-use-data-driven-tests-on-my-windows-phone-app"></a>问：可以在我的 Windows Phone 应用程序使用数据驱动的测试？  
