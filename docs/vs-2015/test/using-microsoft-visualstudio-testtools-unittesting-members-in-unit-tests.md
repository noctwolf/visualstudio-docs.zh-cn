...
本主题的最新版本，请参阅[单元测试中使用 Microsoft.VisualStudio.TestTools.UnitTesting 成员](https://docs.microsoft.com/visualstudio/test/using-microsoft-visualstudio-testtools-unittesting-members-in-unit-tests)。
