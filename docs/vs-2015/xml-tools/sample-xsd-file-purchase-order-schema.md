---
title: 示例 XSD 文件： 采购订单架构 |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47481593"
---
# <a name="sample-xsd-file-purchase-order-schema"></a>示例 XSD 文件：订单架构
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[示例 XSD 文件： 采购订单架构](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-purchase-order-schema)。  
