...
可以使用 Visual C++ 项目中的“编辑并继续”。 请参阅[支持的代码更改 （c + +）](../debugger/supported-code-changes-cpp.md)有关限制的编辑并继续的信息。  
 ...
 [/Zo （增强优化调试）](http://msdn.microsoft.com/library/eea8d89a-7fe0-4fe1-86b2-7689bbebbd7f)在 Visual Studio 2013 Update 3 中引入的编译器选项将其他信息添加到.pdb （符号） 文件以二进制文件的编译而无需[/Od （禁用 （调试））](http://msdn.microsoft.com/library/aafb762y.aspx)选项。  
