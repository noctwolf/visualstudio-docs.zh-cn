...
本主题的最新版本，请参阅[错误： 调试并不是&#39;t 可能由于系统上启用了内核调试器](https://docs.microsoft.com/visualstudio/debugger/error-debugging-isn-t-possible-because-a-kernel-debugger-is-enabled-on-the-system)。  
