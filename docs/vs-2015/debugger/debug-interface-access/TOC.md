# [调试接口访问 SDK](debug-interface-access-sdk.md)
## [入门](getting-started-debug-interface-access-sdk.md)
### [概述](overview-debug-interface-access-sdk.md)
### [查询 .Pdb 文件](querying-the-dot-pdb-file.md)
## [符号和符号标记](symbols-and-symbol-tags.md)
### [符号位置](symbol-locations.md)
### [符号类型的词法层次结构](lexical-hierarchy-of-symbol-types.md)
#### [批注](annotation.md)
#### [块](block.md)
#### [编译单位](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [自定义（调试接口访问 SDK）](custom-debug-interface-access-sdk.md)
#### [数据（调试界面访问 SDK）](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [函数（调试接口访问 SDK）](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [标签（调试接口访问 SDK）](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Thunk](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [符号类型的类层次结构](class-hierarchy-of-symbol-types.md)
#### [ArrayType](arraytype.md)
#### [BaseClass](baseclass.md)
#### [BaseType](basetype.md)
#### [CustomType](customtype.md)
#### [维度](dimension.md)
#### [枚举（调试接口访问 SDK）](enum-debug-interface-access-sdk.md)
#### [友元（调试接口访问 SDK）](friend-debug-interface-access-sdk.md)
#### [FunctionArgType](functionargtype.md)
#### [FunctionType](functiontype.md)
#### [ManagedType](managedtype.md)
#### [PointerType](pointertype.md)
#### [Typedef（调试接口访问 SDK）](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [引用](debug-interface-access-sdk-reference.md)
### [接口（调试接口访问 SDK）](interfaces-debug-interface-access-sdk.md)
...
### [枚举和结构](enumerations-and-structures.md)
#### [BasicType 枚举](basictype.md)
#### [CV_access_e 枚举](cv-access-e.md)
#### [CV_call_e 枚举](cv-call-e.md)
#### [CV_CFL_LANG 枚举](cv-cfl-lang.md)
#### [CV_CPU_TYPE_e 枚举](cv-cpu-type-e.md)
#### [CV_HREG_e 枚举](cv-hreg-e.md)
#### [DataKind 枚举](datakind.md)
#### [DiaAddressMapEntry 结构](diaaddressmapentry.md)
#### [LocationType 枚举](locationtype.md)
#### [MemoryTypeEnum 枚举](memorytypeenum.md)
#### [NameSearchOptions 枚举](namesearchoptions.md)
#### [StackFrameTypeEnum 枚举](stackframetypeenum.md)
#### [SymTagEnum 枚举](symtagenum.md)
#### [THUNK_ORDINAL 枚举](thunk-ordinal.md)
#### [UdtKind 枚举](udtkind.md)
