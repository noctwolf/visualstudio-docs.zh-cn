...
ms.locfileid: "47469915"
---
# <a name="how-to-verify-iis-property-settings"></a>如何：验证 IIS 属性设置
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[如何： 验证 IIS 属性设置](https://docs.microsoft.com/visualstudio/debugger/how-to-verify-iis-property-settings)。  
...
5.  对于 ATL Server 应用程序，请验证 DEBUG 谓词是否与您的 ISAPI 扩展相关联。 有关详细信息，请参阅[如何： 将相关联调试谓词进行扩展的](http://msdn.microsoft.com/en-us/50d261d3-4bd4-41c0-b44e-3591086f121e)。  
  
6.  有关[!INCLUDE[vstecasp](../includes/vstecasp-md.md)]应用程序中，确保应用程序中设置应用程序名称的虚拟文件夹**Internet 信息服务 (IIS) 管理器**， **Internet 服务管理器**或**Internet 信息服务**。  
...
7.  有关[!INCLUDE[vstecasp](../includes/vstecasp-md.md)]应用程序中，单击**ASP.NET**选项卡，确认正确版本的[!INCLUDE[vstecasp](../includes/vstecasp-md.md)]指定。  
