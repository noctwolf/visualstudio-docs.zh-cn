...
|[快速入门：调试 JavaScript](../debugger/quickstart-debug-javascript-using-the-console.md)|使用控制台调试 JavaScript 演示如何以交互方式调试 JavaScript 应用程序使用[JavaScript 控制台命令](../debugger/javascript-console-commands.md)。|
...
## <a name="see-also"></a>请参阅
 [在 Visual Studio 中 （在 MSDN 库中） 中进行调试](http://go.microsoft.com/fwlink/?LinkID=226896)
