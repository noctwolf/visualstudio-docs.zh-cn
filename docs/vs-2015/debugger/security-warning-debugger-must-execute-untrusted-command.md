...
本主题的最新版本，请参阅[安全警告： 调试器必须执行不受信任的命令](https://docs.microsoft.com/visualstudio/debugger/security-warning-debugger-must-execute-untrusted-command)。  
