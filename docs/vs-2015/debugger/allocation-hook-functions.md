...
```  
 ...
 将指针传递给[_CrtSetAllocHook](http://msdn.microsoft.com/library/405df37b-2fd1-42c8-83bc-90887f17f29d)属于类型 **_CRT_ALLOC_HOOK**CRTDBG 中定义。H:  
