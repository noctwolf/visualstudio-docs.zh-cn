...
本主题的最新版本，请参阅[如何： 在调用堆栈窗口中的缺少本机框架时跳出托管代码](https://docs.microsoft.com/visualstudio/debugger/how-to-step-out-of-managed-code-when-native-frames-are-missing-from-the-call-stack-window)。  
