...
2. 在项目类型窗格中，打开**Visual Basic**， **Visual C#** ，或**Visual C++** 节点，然后  
    ...
    2. 视觉对象C++，选择**CLR**节点，然后选择**Windows 窗体应用程序**中**模板**窗格...  
...
5. 在中**监视 1**窗口中，单击某一空行。 在中**名称**列中，键入`textBox1.Text`(如果使用 Visual Basic、 Visual C#，或 J#) 或`textBox1->Text`(如果使用的C++)，然后按 ENTER。  
