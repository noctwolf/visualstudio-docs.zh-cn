...
本主题的最新版本，请参阅[CA2118： 检查 SuppressUnmanagedCodeSecurityAttribute 用法](https://docs.microsoft.com/visualstudio/code-quality/ca2118-review-suppressunmanagedcodesecurityattribute-usage)。
