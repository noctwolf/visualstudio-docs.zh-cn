...
2.  在菜单栏上依次选择**构建**，**对解决方案运行代码分析**。  
     ...
     请考虑 _In\_在本部分中的示例。 如果对其运行代码分析，则显示此警告：  
...
### <a name="example-the-out-annotation"></a>示例： _Out\_批注  
...
### <a name="example-the-success-annotation-in-combination-with-out"></a>示例： _Success\_结合 _Out 批注\_  
