...
ms.locfileid: "47587680"
---
# <a name="ca2222-do-not-decrease-inherited-member-visibility"></a>CA2222：不要递减继承成员的可见性
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA2222： 不要递减继承的成员的可见性](https://docs.microsoft.com/visualstudio/code-quality/ca2222-do-not-decrease-inherited-member-visibility)。
