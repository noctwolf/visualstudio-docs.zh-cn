---
title: CA1017： 将程序集用 ComVisibleAttribute 标记 |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47587648"
---
# <a name="ca1017-mark-assemblies-with-comvisibleattribute"></a>CA1017：用 ComVisibleAttribute 标记程序集
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA1017： 用 ComVisibleAttribute 标记程序集](https://docs.microsoft.com/visualstudio/code-quality/ca1017-mark-assemblies-with-comvisibleattribute)。
