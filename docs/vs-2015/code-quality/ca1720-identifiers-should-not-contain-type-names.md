...
ms.locfileid: "47492622"
---
# <a name="ca1720-identifiers-should-not-contain-type-names"></a>CA1720：标识符不应包含类型名称
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA1720： 标识符不应包含类型名称](https://docs.microsoft.com/visualstudio/code-quality/ca1720-identifiers-should-not-contain-type-names)。
