...
ms.locfileid: "47492632"
---
# <a name="ca1019-define-accessors-for-attribute-arguments"></a>CA1019：定义特性参数的访问器
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA1019： 定义特性参数的访问器](https://docs.microsoft.com/visualstudio/code-quality/ca1019-define-accessors-for-attribute-arguments)。
