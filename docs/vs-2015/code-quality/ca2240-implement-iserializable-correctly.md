...
ms.locfileid: "47587651"
---
# <a name="ca2240-implement-iserializable-correctly"></a>CA2240：正确实现 ISerializable
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA2240： 实现 ISerializable 正确](https://docs.microsoft.com/visualstudio/code-quality/ca2240-implement-iserializable-correctly)。
