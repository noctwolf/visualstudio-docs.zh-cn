...
ms.locfileid: "47587517"
---
# <a name="ca2220-finalizers-should-call-base-class-finalizer"></a>CA2220：终结器应调用基类的终结器
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA2220： 终结器应调用基类的终结器](https://docs.microsoft.com/visualstudio/code-quality/ca2220-finalizers-should-call-base-class-finalizer)。
