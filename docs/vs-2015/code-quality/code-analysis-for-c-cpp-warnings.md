---
title: C-代码分析C++警告 |Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "65693296"
---
# <a name="code-analysis-for-cc-warnings"></a>C/C++ 代码分析警告
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本节列出了 C/C++ 代码分析警告。 有关代码分析的信息，请参阅[/analyze （代码分析）](https://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08)和[快速启动：为 C 代码分析 /C++](../code-quality/quick-start-code-analysis-for-c-cpp.md)。  
  
## <a name="see-also"></a>请参阅  
 [编写安全代码的准则](https://msdn.microsoft.com/9892fd19-45cd-44b6-9fa8-10f1b5cb6ea4)   
 [分析 C /C++通过使用代码分析的代码质量](../code-quality/analyzing-c-cpp-code-quality-by-using-code-analysis.md)   
