---
title: C + + 警告的代码分析 |Microsoft Docs
ms.custom: ''
ms.date: 11/15/2016
...
ms.locfileid: "51766709"
---
# <a name="code-analysis-for-cc-warnings"></a>C/C++ 代码分析警告
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本节列出了 C/C++ 代码分析警告。 有关代码分析的信息，请参阅[/analyze （代码分析）](http://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08)并[快速入门： C/c + + 代码分析](../code-quality/quick-start-code-analysis-for-c-cpp.md)。  
