...
本主题的最新版本，请参阅[CA2134： 重写基方法时，方法必须保持一致的透明度](https://docs.microsoft.com/visualstudio/code-quality/ca2134-methods-must-keep-consistent-transparency-when-overriding-base-methods)。
