...
ms.locfileid: "47587543"
---
# <a name="ca1408-do-not-use-autodual-classinterfacetype"></a>CA1408：请不要使用 AutoDual ClassInterfaceType
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA1408： 请不要使用 AutoDual ClassInterfaceType](https://docs.microsoft.com/visualstudio/code-quality/ca1408-do-not-use-autodual-classinterfacetype)。
