---
title: CA2213： 应释放可释放字段 |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47587544"
---
# <a name="ca2213-disposable-fields-should-be-disposed"></a>CA2213：应释放可释放的字段
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA2213： 应释放可释放字段](https://docs.microsoft.com/visualstudio/code-quality/ca2213-disposable-fields-should-be-disposed)。
