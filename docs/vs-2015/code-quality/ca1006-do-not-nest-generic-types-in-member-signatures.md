...
ms.locfileid: "47587755"
---
# <a name="ca1006-do-not-nest-generic-types-in-member-signatures"></a>CA1006：不要将泛型类型嵌套在成员签名中
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA1006： 不要将嵌套在成员签名中的泛型类型](https://docs.microsoft.com/visualstudio/code-quality/ca1006-do-not-nest-generic-types-in-member-signatures)。
