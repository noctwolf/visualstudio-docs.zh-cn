...
本主题的最新版本，请参阅[CA1824： 用 NeutralResourcesLanguageAttribute 标记程序集](https://docs.microsoft.com/visualstudio/code-quality/ca1824-mark-assemblies-with-neutralresourceslanguageattribute)。
