...
ms.locfileid: "47587655"
---
# <a name="ca2100-review-sql-queries-for-security-vulnerabilities"></a>CA2100：检查 SQL 查询中是否有安全漏洞
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[CA2100： 检查 SQL 查询是否存在安全漏洞](https://docs.microsoft.com/visualstudio/code-quality/ca2100-review-sql-queries-for-security-vulnerabilities)。
...
## <a name="see-also"></a>请参阅
 [安全性概述](http://msdn.microsoft.com/library/33e09965-61d5-48cc-9e8c-3b047cc4f194)
