...
本主题的最新版本，请参阅[CA2237： 以 SerializableAttribute 标记 ISerializable 类型](https://docs.microsoft.com/visualstudio/code-quality/ca2237-mark-iserializable-types-with-serializableattribute)。
