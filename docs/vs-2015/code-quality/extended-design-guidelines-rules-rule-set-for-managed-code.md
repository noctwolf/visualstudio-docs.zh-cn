...
|[CA1700](../code-quality/ca1700-do-not-name-enum-values-reserved.md)|未命名的枚举值 Reserved|  
...
|[CA1714](../code-quality/ca1714-flags-enums-should-have-plural-names.md)|枚举应采用复数形式的名称|  
...
|[CA1719](../code-quality/ca1719-parameter-names-should-not-match-member-names.md)|参数名不应与成员名称|  
...
|[CA1724](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|类型名不应与命名空间|  
