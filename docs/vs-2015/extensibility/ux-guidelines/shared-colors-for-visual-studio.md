...
本主题的最新版本，请参阅[共享 Visual Studio 的颜色](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/shared-colors-for-visual-studio)。  
...
### <a name="tag"></a>标记  
 ...
 ![标记](../../extensibility/ux-guidelines/media/0303-177-tag.png "0303年 177_Tag")  
