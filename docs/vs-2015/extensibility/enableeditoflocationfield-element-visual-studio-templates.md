...
本主题的最新版本，请参阅[EnableEditOfLocationField 元素 （Visual Studio 模板）](https://docs.microsoft.com/visualstudio/extensibility/enableeditoflocationfield-element-visual-studio-templates)。  
