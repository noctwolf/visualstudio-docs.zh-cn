...
## <a name="using-asyncpackage-to-load-vspackages-in-the-background"></a>使用 AsyncPackage 加载 Vspackage 背景  
 AsyncPackage 类允许在 Visual Studio 中更好的 UI 响应能力在后台线程上加载的包。 有关详细信息，请参阅[如何：使用 AsyncPackage 加载 Vspackage 背景](../extensibility/how-to-use-asyncpackage-to-load-vspackages-in-the-background.md)。  
