...
ms.locfileid: "47470570"
---
# <a name="showbydefault-visual-studio-templates"></a>ShowByDefault（Visual Studio 模板）
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[ShowByDefault （Visual Studio 模板）](https://docs.microsoft.com/visualstudio/extensibility/showbydefault-visual-studio-templates)。  
