...
ms.locfileid: "47472196"
---
# <a name="projectsubtype-element-visual-studio-templates"></a>ProjectSubType 元素（Visual Studio 模板）
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[ProjectSubType 元素 （Visual Studio 模板）](https://docs.microsoft.com/visualstudio/extensibility/projectsubtype-element-visual-studio-templates)。  
...
-   `SmartDevice-NETCFv1`： 指定此模板针对[!INCLUDE[Compact](../includes/compact-md.md)]1.0 版。  
