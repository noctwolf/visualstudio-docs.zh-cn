...
ms.locfileid: "47468483"
---
# <a name="getting-local-values"></a>获取局部值
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

本主题的最新版本，请参阅[获取本地值](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-values)。  
