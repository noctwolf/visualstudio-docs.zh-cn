...
ms.locfileid: "47470994"
---
# <a name="when-a-breakpoint-binds-or-becomes-unbound"></a>断点绑定或解除绑定时
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

本主题的最新版本，请参阅[时断点绑定或将成为未绑定](https://docs.microsoft.com/visualstudio/extensibility/debugger/when-a-breakpoint-binds-or-becomes-unbound)。  
