...
ms.locfileid: "47470613"
---
# <a name="taskstaterantocompletion-field"></a>TASK_STATE_RAN_TO_COMPLETION 字段
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

本主题的最新版本，请参阅[TASK_STATE_RAN_TO_COMPLETION 字段](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-ran-to-completion-field)。  
