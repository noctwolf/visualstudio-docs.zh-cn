...
ms.locfileid: "47481564"
---
# <a name="attaching-to-the-program"></a>附加到程序
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

本主题的最新版本，请参阅[附加到程序](https://docs.microsoft.com/visualstudio/extensibility/debugger/attaching-to-the-program)。  
  
与相应的端口注册您的程序后，必须将调试器附加到你想要调试的程序。  
  
## <a name="choosing-how-to-attach"></a>选择要附加的方式  
