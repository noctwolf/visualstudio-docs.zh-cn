...
本主题的最新版本，请参阅[NumberOfParentCategoriesToRollUp （Visual Studio 模板）](https://docs.microsoft.com/visualstudio/extensibility/numberofparentcategoriestorollup-visual-studio-templates)。  
