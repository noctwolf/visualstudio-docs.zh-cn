...
本主题的最新版本，请参阅[EnableLocationBrowseButton 元素 （Visual Studio 模板）](https://docs.microsoft.com/visualstudio/extensibility/enablelocationbrowsebutton-element-visual-studio-templates)。  
