...
## <a name="in-this-section"></a>本节内容
 ...
 [安装程序配置](https://msdn.microsoft.com/library/faa4ed55-66ce-4792-939f-a5b093f13a2e)用于发现 Visual Studio 2017 的实例的安装程序配置 API。

 [打开文件夹扩展性](https://msdn.microsoft.com/library/0897ae3d-6a09-4d26-90c9-7f3d0b8e5c5d)Visual Studio 2017 中打开的文件夹的工作区 API。
 ...
 <xref:Microsoft.VisualStudio.Text.Formatting>用于在新编辑器中进行格式设置的类。
 ...
 <xref:Microsoft.VisualStudio.ComponentModelHost>用于 Visual Studio 中的 Managed Extensibility Framework (MEF) 的类。
 ...
 <xref:Microsoft.VisualStudio.WCFReference.Interop>用于 Windows Communication Framework 的类。
 ...
 <xref:VSLangProj>用于C#和 Visual Basic 项目自动化。

 <xref:VSLangProj2>用于C#和 Visual Basic 项目自动化。

 <xref:VSLangProj80>用于C#和 Visual Basic 项目自动化。

 <xref:VslangProj90>用于C#和 Visual Basic 项目自动化。

 <xref:VslangProj100>用于C#和 Visual Basic 项目自动化。

 <xref:VSLangProj110>用于C#和 Visual Basic 项目自动化。

 <xref:VSLangProj140>用于C#和 Visual Basic 项目自动化。

 <xref:Microsoft.VisualStudio.Language.CallHierarchy>用于C#和 Visual Basic 自动化。

 <xref:Microsoft.VisualStudio.Language.NavigateTo.Interfaces>用于C#和 Visual Basic 自动化。
 ...
 [对象](../extensibility/objects.md)提供要在环境中使用的对象的列表。
...
## <a name="related-sections"></a>相关章节
 [Visual STUDIO SDK](../extensibility/visual-studio-sdk.md)包含文档、示例和代码, 可帮助您开发与 Visual Studio 集成的产品。
