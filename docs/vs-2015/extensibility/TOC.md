...
# [常见问题解答：将加载项转换为 VSPackage 扩展](faq-converting-add-ins-to-vspackage-extensions.md)
...
### [演练：显示匹配的括号](walkthrough-displaying-matching-braces.md)
...
### [演练：将快捷键与编辑器扩展结合使用](walkthrough-using-a-shortcut-key-with-an-editor-extension.md)
...
### [如何：为专用库创建 Atom 馈送](how-to-create-an-atom-feed-for-a-private-gallery.md)
...
#### [如何：在编辑器中托管另一个编辑器](how-to-host-an-editor-in-another-editor.md)
