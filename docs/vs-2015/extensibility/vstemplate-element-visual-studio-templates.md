...
ms.locfileid: "47479688"
---
# <a name="vstemplate-element-visual-studio-templates"></a>VSTemplate 元素（Visual Studio 模板）
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主题的最新版本，请参阅[VSTemplate 元素 （Visual Studio 模板）](https://docs.microsoft.com/visualstudio/extensibility/vstemplate-element-visual-studio-templates)。  
