...
ms.locfileid: "47477449"
---
# <a name="guids-and-ids-of-visual-studio-toolbars"></a>Visual Studio 工具栏中的 GUID 和 ID
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

本主题的最新版本，请参阅[Guid 和 Id 的 Visual Studio 工具栏](https://docs.microsoft.com/visualstudio/extensibility/internals/guids-and-ids-of-visual-studio-toolbars)。  
