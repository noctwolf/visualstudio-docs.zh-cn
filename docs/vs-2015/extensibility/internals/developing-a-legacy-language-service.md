...
## <a name="in-this-section"></a>本节内容  
 ...
 提供的最小语言服务模型[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]核心编辑器。 用于创建你自己的语言服务，可以作为指南使用此模型。  
 ...
 提供有关如何使用注册你的语言服务信息[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]。  
...
## <a name="related-sections"></a>相关章节  
 ...
 [如何：提供旧版语言服务中的隐藏文本支持](../../extensibility/internals/how-to-provide-hidden-text-support-in-a-legacy-language-service.md)  
