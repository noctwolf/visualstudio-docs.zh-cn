...
- 方法： 这将成为获取传递的关键字。
  ...
  **启用调试工具在 IDE 中的帮助**
  ...
  HKEY_CURRENT_USER\Software\Microsoft\VisualStudio\12.0\Dynamic 帮助键：在零售值中显示调试输出：是
...
运行时 API，请参阅[Windows 帮助 API](https://msdn.microsoft.com/library/windows/desktop/hh447318\(v=vs.85\).aspx)。
