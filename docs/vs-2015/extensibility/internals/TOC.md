...
#### [概述](configuration-options-overview.md)
...
#### [设计决策](source-control-design-decisions.md)
#### [配置详细信息](source-control-configuration-details.md)
#### [项目和编辑器的其他指南](additional-source-control-guidelines-for-projects-and-editors.md)
#### [运行时详细信息](source-control-runtime-details.md)
...
### [体系结构](project-types-architecture.md)
