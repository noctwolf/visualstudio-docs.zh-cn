...
5. 编写以下项目类型组件的代码：  
    ...
    - 项目层次结构和命令处理。 有关详细信息，请参阅[不在生成中：使用 HierUtil7 项目类来实现一种项目类型 (C++)](http://msdn.microsoft.com/a5c16a09-94a2-46ef-87b5-35b815e2f346)，[项目模型的元素](../../extensibility/internals/elements-of-a-project-model.md)，[项目模型核心组件](../../extensibility/internals/project-model-core-components.md)并[MenuCommands 与。OleMenuCommands](../../misc/menucommands-vs-olemenucommands.md)。  
