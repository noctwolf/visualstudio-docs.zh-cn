...
|![了解什么是在每个 SKU](../install/media/sku.png "Sku") |**Sku**： 若要了解什么是用于每个版本的 Visual Studio 2015，请参阅我们[比较 Visual Studio 产品](http://go.microsoft.com/fwlink/?LinkID=242142)页。|
...
|**常见的工具**|适用于 Windows 的 Git （第三方）<br />Visual Studio 的 GitHub 扩展 （第三方）<br /> Visual Studio 扩展性工具|
