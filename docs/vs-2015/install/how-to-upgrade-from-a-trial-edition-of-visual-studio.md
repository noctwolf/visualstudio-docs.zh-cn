...
可以在不注册产品的情况下，在 14 天内评估 Visual Studio 的预发行版本。 通过使用 Microsoft 帐户登录来进行注册之后，预发行许可证在截止日期之前都有效。  
 ...
 你可以在 30 天内评估 Visual Studio Professional 和 Enterprise 版的发行版本，时间从你安装产品时开始计算。 [在登录到 Visual Studio](../ide/signing-in-to-visual-studio.md)的总共 90 天评估期延长 60 天。 如果你未在 30 天内注册 Visual Studio 试用版，则试用期将在安装后 30 天到期。  
...
>  Visual Studio Express 版的发行版本的试用期也为 30 天。 若要无限延长 Visual Studio 学习版的试用期，请登录到 Visual Studio 或注册该产品。  
 ...
 在升级之前，它是建议您下载并查看[Visual Studio 和 MSDN 许可白皮书](http://www.microsoft.com/download/details.aspx?id=13350)从 Microsoft 网站。 有关其他帮助，请参阅[针对 Visual Studio 支持](http://support.microsoft.com/ph/1117/en-us)。  
...
1.  在启动 Visual Studio**以管理员身份运行**模式。  
...
## <a name="see-also"></a>请参阅  
 ...
 [登录到 Visual Studio](../ide/signing-in-to-visual-studio.md)   
 [如何： 查找 Visual Studio 产品密钥](../install/how-to-locate-the-visual-studio-product-key.md)   
 [查找或更改 Team Foundation server 的产品密钥](http://msdn.microsoft.com/library/64f29927-b520-4c9f-b633-bcb527e562cd)   
