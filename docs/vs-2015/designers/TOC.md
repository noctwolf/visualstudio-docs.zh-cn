...
#### [将对象组织到布局容器中](organize-objects-into-layout-containers-in-xaml-designer.md)
#### [如何创建和应用资源](how-to-create-and-apply-a-resource.md)
#### [演练：在 XAML 设计器中绑定数据](walkthrough-binding-to-data-in-xaml-designer.md)
### [使用 Blend for Visual Studio 创建 UI](creating-a-ui-by-using-blend-for-visual-studio.md)
#### [插入控件并修改其行为](insert-controls-and-modify-their-behavior-in-xaml-designer.md)
#### [插入图像、视频和音频剪辑](insert-images-videos-and-audio-clips-in-xaml-designer.md)
#### [绘制形状和路径](draw-shapes-and-paths.md)
#### [修改对象样式](modify-the-style-of-objects-in-blend.md)
#### [动态显示对象](animate-objects-in-xaml-designer.md)
#### [显示数据](display-data-in-blend.md)
#### [键盘快捷方式和修改键](keyboard-shortcuts-and-modifier-keys-in-blend.md)
...
#### [辅助功能产品和服务](accessibility-products-and-services-blend.md)
### [Visual Studio 和 Blend for Visual Studio 中的 XAML 设计器的键盘快捷方式](keyboard-shortcuts-for-xaml-designer.md)
...
###### [如何：生成并运行 LinqToXmlDataBinding 示例](how-to-build-and-run-the-linqtoxmldatabinding-example.md)
...
##### [如何：创建基本 Lambert 着色器](how-to-create-a-basic-lambert-shader.md)
...
##### [演练：创建真实的三维台球](walkthrough-creating-a-realistic-3-d-billiard-ball.md)
...
#### [如何：导出包含预乘 Alpha 的纹理](how-to-export-a-texture-that-has-premultiplied-alpha.md)
