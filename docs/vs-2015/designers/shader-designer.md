...
## <a name="getting-started"></a>入门  
 本节描述如何将 DGSL 着色器添加到 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 项目中，并提供可帮助您入门的基本信息。  
...
### <a name="shader-designer-toolbars"></a>着色器设计器工具栏  
 ...
 影响着色器设计器状态的命令位于主 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 窗口中的“着色器设计器模式”  工具栏上。 设计工具和命令均位于着色器设计器设计图面上的“着色器设计器”  工具栏上。  
