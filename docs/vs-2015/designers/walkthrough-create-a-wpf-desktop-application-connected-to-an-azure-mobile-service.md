...
本主题的最新版本，请参阅[演练： 创建一个 WPF 桌面应用程序连接到 Azure 移动服务](https://docs.microsoft.com/visualstudio/designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service)。  
