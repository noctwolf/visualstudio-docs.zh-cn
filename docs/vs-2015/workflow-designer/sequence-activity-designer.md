...
## <a name="using-the-sequence-activity-designer"></a>使用 Sequence 活动设计器  
 若要添加<xref:System.Activities.Statements.Sequence>活动，请将**序列**活动设计器从**工具箱**拖放到[!INCLUDE[wfd1](../includes/wfd1-md.md)]图面。 若要将子活动添加到此<xref:System.Activities.Statements.Sequence>活动，将从一些其他活动拖放**工具箱**并将其放在带提示文本框中的三角形上"此处放置活动"。  
