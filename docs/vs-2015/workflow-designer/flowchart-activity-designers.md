 ...
 **用于创建工作流定义和管理复杂流控制的。**  [FlowDecision](../workflow-designer/flowdecision-activity-designer.md)  
 根据指定条件是否成立来将控制流分支到两个备选分支之一。  
  
 [FlowSwitch\<T>](../workflow-designer/flowswitch-t-activity-designer.md)  
 在需要两个以上备选分支时，根据匹配条件分支控制流。  
