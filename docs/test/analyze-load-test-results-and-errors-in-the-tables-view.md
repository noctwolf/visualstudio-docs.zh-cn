---
title: 分析 Visual Studio 中的负载测试结果和错误
ms.date: 10/19/2016
ms.topic: conceptual
f1_keywords:
...
|**最大响应时间**|不包括思考时间。|否|
|**中值响应时间**|不包括思考时间。|否|
|**90% 响应时间**|事务时间值的 90%。 不包括思考时间。 注意：这与使用“90% 事务时间”值的 Visual Studio Team System 2008 Test Load Agent 不同。|否|
