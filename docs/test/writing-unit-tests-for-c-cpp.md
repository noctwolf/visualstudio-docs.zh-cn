...
- **CTest** 支持随附在 [CMake Tools for Visual Studio](/cpp/build/cmake-tools-for-visual-cpp) 组件中，该组件是“使用 C++ 的桌面开发”  工作负荷的一部分。 但是，CTest 尚未与“测试资源管理器”  集成。 有关详细信息，请参阅[如何：在 Visual Studio 中使用 CTest](how-to-use-ctest-for-cpp.md)。
