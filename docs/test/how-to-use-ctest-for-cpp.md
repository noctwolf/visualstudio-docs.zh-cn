...
### <a name="visual-studio-2017-version-156-and-later"></a>Visual Studio 2017 版本 15.6 及更高版本

在 Visual Studio 2017 版本 15.6 及更高版本中，CTest 与“测试资源管理器”完全集成，同时支持 Google 和 Boost 单元测试框架。 默认情况下，这些框架作为组件包含在“使用 C++ 的桌面开发”工作负载中。 但是，如果你要从较旧版本的 Visual Studio 升级项目，可能需要通过使用 Visual Studio 安装程序来安装这些框架。
...
![在 Visual Studio 2017 版本 15.5 中运行 CTest 测试](media/cpp-cmake-run-tests.png)
