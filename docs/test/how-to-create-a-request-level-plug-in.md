---
title: 在 Visual Studio 中创建适用于 Web 性能测试的请求级插件
ms.date: 10/19/2016
ms.topic: conceptual
helpviewer_keywords:
...
1.  在解决方案资源管理器中，右击解决方案， 选择“添加”，然后选择“新建项目”。
...
7.  在解决方案资源管理器中，右键单击包含负载测试（要向其添加 Web 性能测试请求测试插件）的 Web 性能和负载测试项目的顶级节点。 选择“添加引用”。
