---
title: 为 Web 性能测试结果查看器创建 Visual Studio 外接程序 | Microsoft Docs
ms.date: 10/20/2016
ms.topic: conceptual
helpviewer_keywords:
...
## <a name="build-the-webperftestresultsvieweraddin-solution"></a>生成 WebPerfTestResultsViewerAddin 解决方案
