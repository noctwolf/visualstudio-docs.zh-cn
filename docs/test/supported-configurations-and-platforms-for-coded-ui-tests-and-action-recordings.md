---
title: Visual Studio 中编码的 UI 测试的配置和平台
ms.date: 2015-10-04
...
| 边缘 | 不支持录制操作步骤或借助生成器来查看对象属性。 可使用 Visual Studio 2015 Update 2 及更高版本，通过[编码的 UI 跨浏览器测试扩展](https://visualstudiogallery.msdn.microsoft.com/11cfc881-f8c9-4f96-b303-a2780156628d)在 Microsoft Edge 浏览器中播放测试 |
