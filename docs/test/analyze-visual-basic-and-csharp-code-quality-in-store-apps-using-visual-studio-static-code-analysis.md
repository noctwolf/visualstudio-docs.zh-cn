---
title: "使用 Visual Studio 静态代码分析来分析 UWP 应用中的 Visual Basic 和 C# 代码质量 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="analyze-visual-basic-and-c-code-quality-in-uwp-apps-using-visual-studio-static-code-analysis"></a>使用 Visual Studio 静态代码分析来分析 UWP 应用中的 Visual Basic 和 C# 代码质量
...
2.  在项目属性页中，选择“代码分析”，然后选中“生成时启用代码分析(定义 CODEANALYSIS 常量)”。  
 ...
 ![代码分析窗口](../test/media/ca_managed_collapsed.png "CA_Managed_Collapsed")  
  
##  <a name="BKMK_Analyze"></a>分析和解决代码分析警告  
 若要分析某个具体的警告，请在“代码分析”窗口中单击该警告的标题。 随后该警告将展开，显示有关问题的详细信息。  
  
 ![展开的代码分析警告](../test/media/ca_managed_callouts.png "CA_Managed_Callouts")  
  
 展开警告后，将在 Visual Studio 代码编辑器中突出显示导致警告的代码行。  
  
 ![代码分析文本突出显示](../test/media/ca_managed_sourceline.png "CA_Managed_SourceLine")  
...
##  <a name="BKMK_Search"></a>搜索和筛选代码分析结果  
 ...
 ![搜索并筛选代码分析窗口](../test/media/ca_searchfilter.png "CA_SearchFilter")  
...
##  <a name="BKMK_Warnings"></a> Visual Basic 和 C# 代码分析警告  
 ...
 [CA1821：移除空的终结器](http://msdn.microsoft.com/library/bb264476.aspx)  
