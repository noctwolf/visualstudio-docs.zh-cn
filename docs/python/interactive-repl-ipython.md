---
title: IPython REPL（交互式窗口）| Microsoft Docs
...
- 还可以在自己的 Azure 上的 Windows 或 Linux 虚拟机上运行 Jupyter（以前称为 IPython）。 有关详细信息，请参阅[在 Azure 上创建 Azure VM、安装 Jupyter 以及运行 Jupyter 笔记本](/azure/virtual-machines/virtual-machines-linux-jupyter-notebook)。
