---
title: "如何在 Visual Studio 中为 Python 项目自定义菜单命令 | Microsoft Docs"
description: "演示如何在 Visual Studio 中编辑项目和定向文件以将自定义命令添加到 Python 项目上下文菜单中。 命令能够在可执行程序、脚本、模块、内联代码片段和 pip 上进行调用。"
ms.custom: 
ms.date: 02/02/2018
ms.reviewer: 
ms.suite: 
