...
ms.locfileid: "34752128"
---
# <a name="tutorial-step-4-use-the-full-flask-web-project-template"></a>教程步骤 4：使用完整的 Flask Web 项目模板
...
- GitHub 上的教程源代码：[Microsoft/python-sample-vs-learn-flask](https://github.com/Microsoft/python-sample-vs-learn-flask)