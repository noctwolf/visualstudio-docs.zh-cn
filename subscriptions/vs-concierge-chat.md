---
title: Visual Studio 订阅中的接待聊天室权益 | Microsoft 文档
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 12/19/2018
...
<sup>1</sup>包括：限制转售 (NFR)、Visual Studio 行业合作伙伴 (VSIP)、Microsoft 认证培训师、BizSpark。不包括：FTE、Microsoft 最有价值专家 (MVP)、区域总监 (RD)、Microsoft 合作伙伴网络 (MPN)、Imagine。
