...
## <a name="marketplacehttpsmarketplacevisualstudiocom"></a>
  [市场](https://marketplace.visualstudio.com/)

需要续订 Visual Studio 云订阅？  想要下载 Visual Studio 系列产品的最新扩展？  市场可以帮助用户找到扩展、工具和服务，用于增强 Visual Studio Team Services、Team Foundation Server，以及 Visual Studio Code。 甚至可以成为发布者，在市场上发布你自己的扩展。
