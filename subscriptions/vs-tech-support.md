...
4. 完成此过程后，你将收到一封电子邮件，其中包含在创建支持事件时将使用的“合同 ID”和“访问 ID”。 
...
联机提交事件时，系统会首先提示你进行登录。 使用下拉列表，选择需要获得帮助的产品。 例如，要为 Visual Studio Enterprise 2017 提交事件，请选择“开发人员工具”系列，然后选择“Visual Studio 2017”作为产品，然后选择“Visual Studio Enterprise 2017”作为版本。
