        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>开发人员工具</h3>
                        <p>获取 Visual Studio 最新版本的访问权限，适用于 Android、iOS、Windows、macOS、Web 和云应用开发的功能齐全的 IDE 以及电脑或 Mac 上的其他跨平台工具。</p>
                        <ul>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>培训和支持</h3>
                        <p>Visual Studio 订阅包含 Microsoft 和我们的合作伙伴提供的技术和专业培训权益。 培训内容包括各种技术主题相关的最新课程和专业课件，以持续发展你的职业。 获取专家帮助以解决问题和回答问题。 订阅可能包括：</p>
                        <ul>
