...
可使用批量编辑进程一次编辑多个订阅者。 此功能主要用于正在更改公司电子邮件地址的组织，或者决定对下载进行限制的组织。 重要说明：订阅级别（即 Enterprise、Professional 等）和订阅 GUID 无法更改。  如果尝试上传这些更改项，上传将失败。  
...
![编辑许可证 - 批量编辑文件上传](_img\edit-license\edit-license-bulk-file-upload.png)
