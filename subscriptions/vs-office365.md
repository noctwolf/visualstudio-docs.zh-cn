...
ms.locfileid: "66263128"
---
# <a name="office-365-proplus-in-visual-studio-subscriptions"></a>Visual Studio 订阅中的 Office 365 专业增强版

出色地完成工作。 使用不断更新的应用随时随地工作。 Office 365 专业增强版订阅随附以下高级应用：Word、Excel、PowerPoint、OneNote、Outlook、Publisher 和 Access（Publisher 和 Access 仅适用于电脑）。 这些应用可安装在多台设备上，包括 PC、Mac、iPad、iPhone、Android 平板电脑和 Android 手机。 Office 365 还随附其他服务，如 1TB OneDrive 存储空间、每月 60 分钟 Skype 通话，以及 Microsoft 聊天和电话支持。 借助订阅，可获取最新版应用，并自动接收已发布的更新。
