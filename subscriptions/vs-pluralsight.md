...
| 订阅级别/计划                                 | 好处               | 是否续订？                                                         |
|--------------------------------------------------------------|-----------------------|--------------------------------------------------------------------|
| Visual Studio Enterprise Standard                            | 为期 6 个月的订阅 | 不是。  到期后可获得为期 12 个月的受限目录。 |
| Visual Studio Enterprise 年度                              | 为期 6 个月的订阅 | 不是。  到期后可获得为期 12 个月的受限目录。 |
| Visual Studio Enterprise 月度                             | 不可用         |                                                                    |
| Visual Studio Professional Standard                          | 为期 3 个月的订阅 | 不是。  到期后可获得为期 12 个月的受限目录。 |
| Visual Studio Professional 年度                            | 为期 3 个月的订阅 | 不是。  到期后可获得为期 12 个月的受限目录。 |
| Visual Studio Professional 月度                           | 不可用         |                                                                    |
| Visual Studio Test Pro                                       | 为期 3 个月的订阅 | 不是。  到期后可获得为期 12 个月的受限目录。 |
| MSDN 平台                                               | 为期 3 个月的订阅 | 不是。  到期后可获得为期 12 个月的受限目录。 |
| Visual Studio Dev Essentials                                 | 为期 3 个月的订阅 | 不是。                                                                |
...
1. 若要激活订阅，请连接到 [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs)，然后单击 Pluralsight 权益磁贴（位于“专业开发”部分）上的“获取代码”链接。 
...
1. 根据 Visual Studio 订阅，可能会额外提供为期 12 个月的受限课程。  请检查[资格表](#eligibility)这一表格，以查看订阅是否符合条件。
2. 你可以选择直接从 Pluralsight 购买订阅。  请联系 [Pluralsight](http://www.pluralsight.com) 获取完整详细信息。  
