...
就这么简单！  随即可看到一个页面，其中显示根据你的首选项定制的信息。  若要访问开发人员订阅，请转到 [office.com](https://www.office.com) 并使用刚创建的用户 ID 和密码登录。
