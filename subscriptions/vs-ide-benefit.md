...
2.  单击权益磁贴底部的“下载”链接。  你将被重定向到 Visual Studio Enterprise 的“下载结果”页，可在此处下载 IDE 并获取产品密钥以对其进行激活。 也可通过单击蓝色的“获取密钥”链接索取产品密钥，或稍后在[产品密钥](https://my.visualstudio.com/productkeys)页上索取产品密钥。
