...
ms.locfileid: "24569347"
---
# <a name="operator-precedence-javascript"></a>运算符优先级 (JavaScript)
运算符优先级描述了在计算表达式时执行运算的顺序。 先执行具有较高优先级的运算，然后执行较低优先级的运算。 例如，先执行相乘，再执行相加。  
  
## <a name="includejavascriptjavascriptincludesjavascript-mdmd-operators"></a>[!INCLUDE[javascript](../javascript/includes/javascript-md.md)] 运算符  
