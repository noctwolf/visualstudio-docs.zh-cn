---
title: toDateString 方法 (Date) (JavaScript) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639977"
---
# <a name="todatestring-method-date-javascript"></a>toDateString 方法 (Date) (JavaScript)
返回一个字符串值作为日期。  
...
## <a name="remarks"></a>备注  
 ...
 `toDateString`方法返回包含日期，采用当前所在的时区，以一种方便的字符串值易读的格式。  
