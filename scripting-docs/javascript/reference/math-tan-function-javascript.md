---
title: Math.tan 函数 (JavaScript) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638747"
---
# <a name="mathtan-function-javascript"></a>Math.tan 函数 (JavaScript)
返回数字的正切值。  
...
## <a name="remarks"></a>备注  
 所需`radians`自变量是一个包含以弧度计量的角度的数值表达式。  
  
 返回值的数值自变量的正切值`radians`。  
