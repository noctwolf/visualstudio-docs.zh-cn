---
title: Math.sin 函数 (JavaScript) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638517"
---
# <a name="mathsin-function-javascript"></a>Math.sin 函数 (JavaScript)
返回数字的正弦值。  
...
## <a name="remarks"></a>备注  
 `radians`自变量是一个包含以弧度计量的角度的数值表达式。  
