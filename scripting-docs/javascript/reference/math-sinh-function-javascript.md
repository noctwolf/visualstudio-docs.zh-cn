---
title: Math.sinh 函数 (JavaScript) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638597"
---
# <a name="mathsinh-function-javascript"></a>Math.sinh 函数 (JavaScript)
返回数字的反双曲正弦。  
...
## <a name="remarks"></a>备注  
 返回值与 `(exp(x) - exp(-x))/2` 相同。 如果 x 为 `NaN`，则结果为 `NaN`。  
