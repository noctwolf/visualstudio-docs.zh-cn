---
title: Math.atan 函数 (JavaScript) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638437"
---
# <a name="mathatan-function-javascript"></a>Math.atan 函数 (JavaScript)
返回数字的反正切值。  
...
## <a name="remarks"></a>备注  
 所需`number`自变量是数值表达式，它需要反正切值。  
  
 返回值的反正切值`number`自变量，以弧度为单位。  
