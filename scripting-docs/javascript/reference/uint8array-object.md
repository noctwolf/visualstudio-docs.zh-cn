---
title: Uint8Array 对象 |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24641487"
---
# <a name="uint8array-object"></a>Uint8Array 对象
...
|常量|描述|  
|--------------|-----------------|  
|[BYTES_PER_ELEMENT 常量](../../javascript/reference/bytes-per-element-constant-uint8array.md)|数组中每个元素的大小（以字节为单位）。|  
