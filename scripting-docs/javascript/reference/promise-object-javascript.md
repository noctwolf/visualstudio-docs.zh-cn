---
title: Promise 对象 (JavaScript) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24640627"
---
# <a name="promise-object-javascript"></a>Promise 对象 (JavaScript)
...
|[Promise.race 函数](../../javascript/reference/promise-race-function-promise.md)|创建一个新承诺，使其在传入自变量中以第一个承诺解决或拒绝时所用的相同结果值进行解决或拒绝。|  
|[Promise.reject 函数](../../javascript/reference/promise-reject-function-promise.md)|创建新的已拒绝承诺，其结果等于传入的自变量。|  
|[Promise.resolve 函数](../../javascript/reference/promise-resolve-function-promise.md)|创建新的已解决承诺，该承诺的结果等于其自变量。|  
