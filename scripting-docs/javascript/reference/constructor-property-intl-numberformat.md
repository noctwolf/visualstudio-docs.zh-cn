---
title: constructor 属性 (Intl.NumberFormat) |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636107"
---
# <a name="constructor-property-intlnumberformat"></a>constructor 属性 (Intl.NumberFormat)
指定创建一个格式化程序的函数。  
