---
title: IActiveScriptProfilerCallback3 接口 |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
|方法|描述|  
|------------|-----------------|  
|[IActiveScriptProfilerCallback3::SetWebWorkerId 方法](../../winscript/reference/iactivescriptprofilercallback3-setwebworkerid-method.md)|通知探查器有关要用于此分析会话的辅助 ID。|  
