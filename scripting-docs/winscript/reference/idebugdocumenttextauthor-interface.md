---
title: IDebugDocumentTextAuthor 接口 |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24726547"
---
# <a name="idebugdocumenttextauthor-interface"></a>IDebugDocumentTextAuthor 接口
提供的文本文档支持编辑。  
  
 除了从继承的方法`IDebugDocumentText`、`IDebugDocumentTextAuthor`接口公开以下方法。  
  
## <a name="methods-in-vtable-order"></a>Vtable 顺序中的方法  
  
|方法|描述|  
|------------|-----------------|  
|[IDebugDocumentTextAuthor::InsertText](../../winscript/reference/idebugdocumenttextauthor-inserttext.md)|将新文本插入到文档中。|  
