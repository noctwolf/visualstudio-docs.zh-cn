---
title: IJsDebugBreakPoint 接口 |Microsoft 文档
ms.custom: ''
ms.date: 01/18/2017
...
|[IJsDebugBreakPoint::GetDocumentPosition 方法](../../winscript/reference/ijsdebugbreakpoint-getdocumentposition-method.md)|返回其中绑定断点的语句的位置。|  
