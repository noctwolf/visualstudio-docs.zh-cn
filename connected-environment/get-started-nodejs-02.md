---
title: 在云中创建 Node.js 开发环境（使用 Kubernetes 管理其中的容器）- 第 2 步 - 创建 Kubernetes 开发环境 | Microsoft Docs
author: ghogen
ms.author: ghogen
ms.date: 02/20/2018
ms.topic: tutorial
...
上一步：[安装工具](get-started-nodejs-01.md)
...
> [在 Kubernetes 中创建 Node.js 容器](get-started-nodejs-03.md)
