---
title: 安装 Visual Studio 2019 for Mac 预览版
description: 介绍了如何安装 Visual Studio 2019 for Mac 预览版，以及跨平台开发所需的附加组件。
author: conceptdev
ms.author: crdun
ms.date: 11/03/2018
...
ms.locfileid: "54443775"
---
# <a name="install-visual-studio-2019-for-mac-preview"></a>安装 Visual Studio 2019 for Mac 预览版

> [!NOTE]
> Visual Studio 2019 for Mac 预览版可与 Visual Studio for Mac 的最新稳定版本并行安装。 在安装过程中，如果 Visual Studio 不是最新稳定版本，系统会提示你更新现有版本。
...
6. 此时显示可用的工作负载列表。 选择你要使用的工作负载：
    ...
    如果 Visual Studio 2017 for Mac 当前版本低于版本 7.7，系统会提示你同意升级到最新稳定版本（这是支持并行安装所必需的）。 按“继续”同意升级：
