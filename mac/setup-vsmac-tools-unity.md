...
本节介绍如何开始使用Visual Studio for Mac Tools for Unity。

## <a name="install-visual-studio-for-mac"></a>安装 Visual Studio for Mac

### <a name="unity-bundled-installation"></a>Unity 捆绑安装

从Unity 2018.1开始，Visual Studio for Mac是Unity的默认C＃IDE，包含在Unity下载助手以及Unity Hub安装工具中。 前往 [store.unity.com](https://store.unity.com/) 下载 Unity。

在安装过程中，确保在要与Unity一起安装的组件列表中选中Visual Studio for Mac：
...
随附于 Unity 安装的 Visual Studio for Mac 版本可能不是最新版本。 建议检查更新以确保您可以访问最新的工具和功能。
...
自 Unity 2018.1 起，Visual Studio 应该是 Unity 的默认外部脚本编辑器。 您可以确认下是否如此，或者将外部脚本编辑器更改为 Visual Studio：
