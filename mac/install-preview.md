...
ms.locfileid: "34453850"
---
# <a name="installing-preview-releases"></a>安装预览版

新版本的 Visual Studio for Mac 在正式发布之前，作为预览版发布。 在新功能和最新 bug 修补程序完全纳入产品之前，用户可通过预览版抢先尝试这些功能并获取最新修补程序。
